    ...
    static let all: [Chapter] = [
        Chapter(
            ...
            tiles: [
                ...
                Tile(id: 6, name: "The ivory arch", point: WorldPoint(x: 3, y: 0, z: 1.8), kind: .destination),
            ],
        ...
        Chapter(
            ...
            tiles: [
                Tile(id: 0, name: "Garden steps", point: WorldPoint(x: -3, y: 0, z: 0.4), kind: .start),
                Tile(id: 1, name: "West landing", point: WorldPoint(x: -2, y: 0), kind: .floor),
                ...
                Tile(id: 6, name: "Garden gate", point: WorldPoint(x: 3, y: 0, z: 2), kind: .destination),
            ],
            walkways: [Walkway(from: 0, to: 1), Walkway(from: 4, to: 6)],
        ...
        Chapter(
            ...
            tiles: [
                Tile(id: 0, name: "Low steps", point: WorldPoint(x: -5, y: 0, z: 0.4), kind: .start),
                ...
                Tile(id: 10, name: "Sky gate", point: WorldPoint(x: 5, y: 0, z: 2.7), kind: .destination),
            ],
        ...
        Chapter(
            ...
            tiles: [
                Tile(id: 0, name: "Evening steps", point: WorldPoint(x: -5, y: 0, z: 0.4), kind: .start),
                ...
                Tile(id: 10, name: "Home", point: WorldPoint(x: 5, y: 0, z: 3), kind: .destination),
            ],
            walkways: [Walkway(from: 0, to: 1), Walkway(from: 8, to: 10)],
            mechanisms: [
