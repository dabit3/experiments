...
| 6 | Marquee-select three nodes by dragging a rectangle over empty canvas around them, then drag one of them | The three nodes highlight together, the status bar says `3 selected`, and all three (plus their edges) move as a group. |
