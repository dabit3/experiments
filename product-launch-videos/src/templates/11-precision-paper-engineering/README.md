...
off to reveal the hosted Mac menu. Subsequent stills are uncovered by horizontal
sleeves or a vertical divider. Three slightly offset matte sheets, contact shadows,
and a narrow folded return give the carrier depth. Only these surrounding surfaces
move: screenshots never bend, tilt, change color, or simulate app interaction.
...
- `media`: original asset filenames, `framing.fit`, `anchorX`, `anchorY`, optional
  ...
  with no crop. The menu uses x550/y430/w1900/h1000, retaining its real composer.
...
To reproduce the delivered contact sheet after the full render:
