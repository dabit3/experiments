...
def main() -> None:
    ...
    targets = [
        *APP.glob("ios/Runner/Assets.xcassets/AppIcon.appiconset/*.png"),
        *APP.glob("macos/Runner/Assets.xcassets/AppIcon.appiconset/*.png"),
        *APP.glob("android/app/src/main/res/mipmap-*/ic_launcher.png"),
        *APP.glob("web/icons/*.png"),
        APP / "web/favicon.png",
    ]
    for path in targets:
