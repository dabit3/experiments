"use strict";
(self["webpackChunklaunch_video_05_blueprint"] = self["webpackChunklaunch_video_05_blueprint"] || []).push([[155],{
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   H: () => (/* binding */ AdtsDemuxer),
/* harmony export */   s: () => (/* binding */ SAMPLES_PER_AAC_FRAME)
/* harmony export */ });
/* harmony import */ var _shared_aac_misc_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1299);
/* harmony import */ var _demuxer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7202);
/* harmony import */ var _id3_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7576);
/* harmony import */ var _metadata_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5165);
...
/* harmony import */ var _reader_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7735);
/* harmony import */ var _adts_reader_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8475);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class AdtsDemuxer extends _demuxer_js__WEBPACK_IMPORTED_MODULE_1__/* .Demuxer */ .B {
    constructor(input) {
        super(input);
        ...
        this.trackBackings = [];
        this.readingMutex = new _misc_js__WEBPACK_IMPORTED_MODULE_4__/* .AsyncMutex */ .aD();
    ...
    async readMetadata() {
        return this.metadataPromise ??= (async () => {
            ...
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(this.firstFrameHeader);
    ...
    async advanceReader() {
        if (this.lastLoadedPos === 0) {
            ...
            while (true) {
                let slice = this.reader.requestSlice(this.lastLoadedPos, _id3_js__WEBPACK_IMPORTED_MODULE_2__/* .ID3_V2_HEADER_SIZE */ .sY);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(slice))
                    slice = await slice;
                if (!slice) {
                    this.lastSampleLoaded = true;
                    return;
                }
                const id3V2Header = (0,_id3_js__WEBPACK_IMPORTED_MODULE_2__/* .readId3V2Header */ .IX)(slice);
                if (!id3V2Header) {
                    break;
                }
        ...
        let slice = this.reader.requestSliceRange(this.lastLoadedPos, _adts_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_ADTS_FRAME_HEADER_SIZE */ .gc, _adts_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .MAX_ADTS_FRAME_HEADER_SIZE */ .Y$);
        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(slice))
            slice = await slice;
        if (!slice) {
            this.lastSampleLoaded = true;
        ...
        const header = (0,_adts_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readAdtsFrameHeader */ .lh)(slice);
        if (!header) {
            this.lastSampleLoaded = true;
            return;
        }
        ...
        const sampleRate = _shared_aac_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .aacFrequencyTable */ .Im[header.samplingFrequencyIndex];
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(sampleRate !== undefined);
    ...
    async getMetadataTags() {
        ...
        try {
            ...
            let currentPos = 0;
            while (true) {
                let headerSlice = this.reader.requestSlice(currentPos, _id3_js__WEBPACK_IMPORTED_MODULE_2__/* .ID3_V2_HEADER_SIZE */ .sY);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(headerSlice))
                    headerSlice = await headerSlice;
                if (!headerSlice)
                    break;
                const id3V2Header = (0,_id3_js__WEBPACK_IMPORTED_MODULE_2__/* .readId3V2Header */ .IX)(headerSlice);
                if (!id3V2Header) {
                    break;
                }
                let contentSlice = this.reader.requestSlice(headerSlice.filePos, id3V2Header.size);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(contentSlice))
                    contentSlice = await contentSlice;
                if (!contentSlice)
                    break;
                (0,_id3_js__WEBPACK_IMPORTED_MODULE_2__/* .parseId3V2Tag */ .cG)(contentSlice, id3V2Header, this.metadataTags);
...
class AdtsAudioTrackBacking {
    ...
    getLanguageCode() {
        return _misc_js__WEBPACK_IMPORTED_MODULE_4__/* .UNDETERMINED_LANGUAGE */ .IR;
    }
    getCodec() {
        return 'aac';
    }
    getInternalCodecId() {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(this.demuxer.firstFrameHeader);
        return this.demuxer.firstFrameHeader.objectType;
    }
    getNumberOfChannels() {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(this.demuxer.firstFrameHeader);
        const numberOfChannels = _shared_aac_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .aacChannelMap */ .Ti[this.demuxer.firstFrameHeader.channelConfiguration];
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(numberOfChannels !== undefined);
        return numberOfChannels;
    }
    getSampleRate() {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(this.demuxer.firstFrameHeader);
        const sampleRate = _shared_aac_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .aacFrequencyTable */ .Im[this.demuxer.firstFrameHeader.samplingFrequencyIndex];
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(sampleRate !== undefined);
        return sampleRate;
    }
    getDisposition() {
        return {
            ..._metadata_js__WEBPACK_IMPORTED_MODULE_3__/* .DEFAULT_TRACK_DISPOSITION */ .gM,
        };
    }
    ...
    async getPacketAtIndex(sampleIndex, options) {
        ...
        if (options.metadataOnly) {
            data = _packet_js__WEBPACK_IMPORTED_MODULE_5__/* .PLACEHOLDER_DATA */ .T;
        }
        else {
            ...
            data = (0,_reader_js__WEBPACK_IMPORTED_MODULE_6__/* .readBytes */ .io)(slice, rawSample.dataSize);
        }
        return new _packet_js__WEBPACK_IMPORTED_MODULE_5__/* .EncodedPacket */ .Z(data, 'key', rawSample.timestamp, rawSample.duration, sampleIndex, rawSample.dataSize);
    }
    ...
    async getNextPacket(packet, options) {
        ...
        try {
            const sampleIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchExact */ .pl)(this.demuxer.loadedSamples, packet.timestamp, x => x.timestamp);
            if (sampleIndex === -1) {
    ...
    async getPacket(timestamp, options) {
        ...
        try {
            while (true) {
                const index = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(this.demuxer.loadedSamples, timestamp, x => x.timestamp);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   U4: () => (/* binding */ createAes128CbcDecryptStream),
/* harmony export */   UP: () => (/* binding */ Aes128CbcContext),
/* harmony export */   ye: () => (/* binding */ AES_128_BLOCK_SIZE)
/* harmony export */ });
...
class Aes128CbcContext {
    ...
    init({ key, iv }) {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .assert */ .vA)(key.byteLength === 16);
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .assert */ .vA)(iv.byteLength === 16);
        if (!tablesGenerated) {
            generateAesTables();
        }
...
const createAes128CbcDecryptStream = (reader, getInit, close) => {
    ...
    return new ReadableStream({
        pull: async (controller) => {
            ...
            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .isThenable */ .Qg)(nextSlice))
            ...
            const bytesToRead = sliceLength === requestedLength
                ...
                : sliceLength;
            const input = (0,_reader_js__WEBPACK_IMPORTED_MODULE_1__/* .readBytes */ .io)(nextSlice, bytesToRead);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   D: () => (/* binding */ FlacDemuxer)
/* harmony export */ });
...
/* harmony import */ var _metadata_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(5165);
/* harmony import */ var _flac_misc_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(5828);
/* harmony import */ var _shared_bitstream_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(1390);
/* harmony import */ var _id3_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7576);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class FlacDemuxer extends _demuxer_js__WEBPACK_IMPORTED_MODULE_1__/* .Demuxer */ .B {
    constructor(input) {
        super(input);
        ...
        this.readingMutex = new _misc_js__WEBPACK_IMPORTED_MODULE_2__/* .AsyncMutex */ .aD();
        this.lastSampleLoaded = false;
        this.reader = input._reader;
    }
    async getMetadataTags() {
    ...
    async getTrackBackings() {
        await this.readMetadata();
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(this.trackBacking);
    ...
    async readMetadata() {
        return (this.metadataPromise ??= (async () => {
            ...
            let currentPos = 0;
            while (true) {
                let headerSlice = this.reader.requestSlice(currentPos, _id3_js__WEBPACK_IMPORTED_MODULE_8__/* .ID3_V2_HEADER_SIZE */ .sY);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .isThenable */ .Qg)(headerSlice))
                    headerSlice = await headerSlice;
                if (!headerSlice) {
                    this.lastSampleLoaded = true;
                    return;
                }
                const id3V2Header = (0,_id3_js__WEBPACK_IMPORTED_MODULE_8__/* .readId3V2Header */ .IX)(headerSlice);
                if (!id3V2Header) {
                    break;
                }
                let contentSlice = this.reader.requestSlice(headerSlice.filePos, id3V2Header.size);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .isThenable */ .Qg)(contentSlice))
                    contentSlice = await contentSlice;
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(contentSlice);
                (0,_id3_js__WEBPACK_IMPORTED_MODULE_8__/* .parseId3V2Tag */ .cG)(contentSlice, id3V2Header, this.metadataTags);
                currentPos = headerSlice.filePos + id3V2Header.size;
            }
            ...
            while (this.reader.fileSize === null
                ...
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .isThenable */ .Qg)(sizeSlice))
                    sizeSlice = await sizeSlice;
                currentPos += 4;
                if (sizeSlice === null) {
                    throw new Error(`Metadata block at position ${currentPos} is too small! Corrupted file.`);
                }
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(sizeSlice);
                const byte = (0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readU8 */ .eo)(sizeSlice); // first bit: isLastMetadata, remaining 7 bits: metaBlockType
                const size = (0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readU24Be */ .n2)(sizeSlice);
                const isLastMetadata = (byte & 0x80) !== 0;
                const metaBlockType = byte & 0x7f;
                switch (metaBlockType) {
                    case _codec_data_js__WEBPACK_IMPORTED_MODULE_0__/* .FlacBlockType */ .A3.STREAMINFO: {
                        // Parse streaminfo block
                        // https://www.rfc-editor.org/rfc/rfc9639.html#section-8.2
                        let streamInfoBlock = this.reader.requestSlice(currentPos, size);
                        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .isThenable */ .Qg)(streamInfoBlock))
                            streamInfoBlock = await streamInfoBlock;
                        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(streamInfoBlock);
                        if (streamInfoBlock === null) {
                            throw new Error(`StreamInfo block at position ${currentPos} is too small! Corrupted file.`);
                        }
                        const streamInfoBytes = (0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readBytes */ .io)(streamInfoBlock, 34);
                        const bitstream = new _shared_bitstream_js__WEBPACK_IMPORTED_MODULE_7__/* .Bitstream */ ._(streamInfoBytes);
                    ...
                    case _codec_data_js__WEBPACK_IMPORTED_MODULE_0__/* .FlacBlockType */ .A3.VORBIS_COMMENT: {
                        ...
                        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .isThenable */ .Qg)(vorbisCommentBlock))
                            vorbisCommentBlock = await vorbisCommentBlock;
                        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(vorbisCommentBlock);
                        (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_0__/* .readVorbisComments */ .Oc)((0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readBytes */ .io)(vorbisCommentBlock, size), this.metadataTags);
                        break;
                    }
                    case _codec_data_js__WEBPACK_IMPORTED_MODULE_0__/* .FlacBlockType */ .A3.PICTURE: {
                        // Parse picture block
                        // https://www.rfc-editor.org/rfc/rfc9639.html#name-picture
                        let pictureBlock = this.reader.requestSlice(currentPos, size);
                        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .isThenable */ .Qg)(pictureBlock))
                            pictureBlock = await pictureBlock;
                        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(pictureBlock);
                        const pictureType = (0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readU32Be */ .cN)(pictureBlock);
                        const mediaTypeLength = (0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readU32Be */ .cN)(pictureBlock);
                        const mediaType = _misc_js__WEBPACK_IMPORTED_MODULE_2__/* .textDecoder */ .su.decode((0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readBytes */ .io)(pictureBlock, mediaTypeLength));
                        const descriptionLength = (0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readU32Be */ .cN)(pictureBlock);
                        const description = _misc_js__WEBPACK_IMPORTED_MODULE_2__/* .textDecoder */ .su.decode((0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readBytes */ .io)(pictureBlock, descriptionLength));
                        pictureBlock.skip(4 + 4 + 4 + 4); // Skip width, height, color depth, number of indexed colors
                        const dataLength = (0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readU32Be */ .cN)(pictureBlock);
                        const data = (0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readBytes */ .io)(pictureBlock, dataLength);
    ...
    async readNextFlacFrame({ startPos, isFirstPacket, }) {
        ...
        while (true) {
            ...
            const nextByte = (0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readU8 */ .eo)(slice);
            if (nextByte === 0xff) {
                const positionBeforeReading = slice.filePos;
                const byteAfterNextByte = (0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readU8 */ .eo)(slice);
    ...
    readFlacFrameHeader({ slice, isFirstPacket, }) {
        ...
        const bytes = (0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readBytes */ .io)(slice, 4);
        const bitstream = new _shared_bitstream_js__WEBPACK_IMPORTED_MODULE_7__/* .Bitstream */ ._(bytes);
        ...
        if (this.blockingBit === null) {
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(isFirstPacket);
        ...
        const blockSizeOrUncommon = (0,_flac_misc_js__WEBPACK_IMPORTED_MODULE_6__/* .getBlockSizeOrUncommon */ .iv)(bitstream.readBits(4));
        if (!blockSizeOrUncommon) {
            // This cannot be a valid FLAC frame, the syncword was just coincidental
            return null;
        }
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(this.audioInfo);
        const sampleRateOrUncommon = (0,_flac_misc_js__WEBPACK_IMPORTED_MODULE_6__/* .getSampleRateOrUncommon */ .oP)(bitstream.readBits(4), this.audioInfo.sampleRate);
        ...
        const num = (0,_flac_misc_js__WEBPACK_IMPORTED_MODULE_6__/* .readCodedNumber */ .X7)(slice);
        const blockSize = (0,_flac_misc_js__WEBPACK_IMPORTED_MODULE_6__/* .readBlockSize */ .f6)(slice, blockSizeOrUncommon);
        const sampleRate = (0,_flac_misc_js__WEBPACK_IMPORTED_MODULE_6__/* .readSampleRate */ .Ld)(slice, sampleRateOrUncommon);
        if (sampleRate === null) {
            // This cannot be a valid FLAC frame, the syncword was just coincidental
            return null;
        }
        ...
        const crc = (0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readU8 */ .eo)(slice);
        slice.skip(-size);
        slice.skip(-1);
        const crcCalculated = (0,_flac_misc_js__WEBPACK_IMPORTED_MODULE_6__/* .calculateCrc8 */ .Be)((0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readBytes */ .io)(slice, size));
    ...
    async advanceReader() {
        await this.readMetadata();
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(this.lastLoadedPos !== null);
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(this.audioInfo);
...
class FlacAudioTrackBacking {
    ...
    getDisposition() {
        return {
            ..._metadata_js__WEBPACK_IMPORTED_MODULE_5__/* .DEFAULT_TRACK_DISPOSITION */ .gM,
        };
    }
    async getDecoderConfig() {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(this.demuxer.audioInfo);
    ...
    async getPacket(timestamp, options) {
        ...
        try {
            while (true) {
                const packetIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .binarySearchLessOrEqual */ .eE)(this.demuxer.loadedSamples, timestamp, x => x.blockOffset / this.demuxer.audioInfo.sampleRate);
                if (packetIndex === -1) {
                    await this.demuxer.advanceReader();
                    continue;
                }
    ...
    async getPacketAtIndex(sampleIndex, options) {
        ...
        if (options.metadataOnly) {
            ...
            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .isThenable */ .Qg)(slice))
                slice = await slice;
            if (!slice) {
                return null; // Data didn't fit into the rest of the file
            }
            data = (0,_reader_js__WEBPACK_IMPORTED_MODULE_4__/* .readBytes */ .io)(slice, rawSample.byteSize);
        }
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(this.demuxer.audioInfo);
        ...
        return new _packet_js__WEBPACK_IMPORTED_MODULE_3__/* .EncodedPacket */ .Z(data, 'key', timestamp, duration, sampleIndex, rawSample.byteSize);
    }
...
/* harmony export */ });
/* unused harmony exports asc, findUnderlyingFrameRate */
/* harmony import */ var _codec_data_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6297);
...
const requireSync = (value, getterName, asyncName) => {
    if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(value)) {
...
const toValidatedPredicate = (predicate) => {
    ...
    return predicate
        ? (track) => {
            ...
            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(result)) {
...
class InputVideoTrack extends InputTrack {
    ...
    async computeFrameRateMetrics(options = {}) {
        ...
        if (options.targetPacketCount !== undefined
            && (!(0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isNumber */ .Et)(options.targetPacketCount) || options.targetPacketCount < 0)) {
    ...
    return {
        filter: queryA?.filter || queryB?.filter
            ? (track) => {
                ...
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(resultA)) {
        ...
        sortBy: queryA?.sortBy || queryB?.sortBy
            ? (track) => {
                ...
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(resultA) || (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(resultB)) {
...
const queryInputTracks = async (tracks, query) => {
    ...
    if (query?.filter) {
        ...
        const hasAsyncFilter = filterMatches.some(x => (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(x));
        if (hasAsyncFilter) {
    ...
    const hasAsyncSort = sortValues.some(x => (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(x));
...
const simplestFractionBetween = (lo, hi, maxDenominator) => {
    for (let den = 1; den <= maxDenominator; den++) {
        ...
        if (num / den < hi) {
            return (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .simplifyRational */ .Yf)({ num, den });
        }
    }
    return null;
};
...
/* harmony import */ var _input_format_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5608);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   T: () => (/* binding */ IsobmffDemuxer)
/* harmony export */ });
/* harmony import */ var _shared_aac_misc_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1299);
/* harmony import */ var _codec_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1188);
/* harmony import */ var _codec_data_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6297);
/* harmony import */ var _demuxer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7202);
/* harmony import */ var _misc_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3912);
/* harmony import */ var _packet_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3936);
/* harmony import */ var _isobmff_misc_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1826);
/* harmony import */ var _isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8561);
/* harmony import */ var _reader_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7735);
/* harmony import */ var _metadata_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(5165);
/* harmony import */ var _shared_ac3_misc_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(7553);
/* harmony import */ var _shared_bitstream_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(1390);
/* harmony import */ var _aes_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(3373);
/* harmony import */ var _logging_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(6103);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class IsobmffDemuxer extends _demuxer_js__WEBPACK_IMPORTED_MODULE_3__/* .Demuxer */ .B {
    constructor(input) {
        super(input);
        this.moovSlice = null;
    ...
    async getMimeType() {
        ...
        return (0,_isobmff_misc_js__WEBPACK_IMPORTED_MODULE_6__/* .buildIsobmffMimeType */ .Xh)({
    ...
    readMetadata() {
        return this.metadataPromise ??= (async () => {
            ...
            while (true) {
                let slice = this.reader.requestSliceRange(currentPos, _isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_BOX_HEADER_SIZE */ .ZM, _isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .MAX_BOX_HEADER_SIZE */ .Xk);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(slice))
                    slice = await slice;
                if (!slice)
                    break;
                const startPos = currentPos;
                const boxInfo = (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readBoxHeader */ .Vl)(slice);
                if (!boxInfo) {
                    break;
                }
                if (boxInfo.name === 'ftyp' || boxInfo.name === 'styp') {
                    const majorBrand = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readAscii */ .IT)(slice, 4);
                    this.isQuickTime = majorBrand === 'qt  ';
                }
                else if (boxInfo.name === 'moov') {
                    // Found moov, load it
                    let moovSlice = this.reader.requestSlice(slice.filePos, boxInfo.contentSize);
                    if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(moovSlice))
            ...
            if (lookForMfraBox) {
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(this.reader.fileSize !== null);
                // The last 4 bytes may contain the size of the mfra box at the end of the file
                let lastWordSlice = this.reader.requestSlice(this.reader.fileSize - 4, 4);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(lastWordSlice))
                    lastWordSlice = await lastWordSlice;
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(lastWordSlice);
                const lastWord = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(lastWordSlice);
                const potentialMfraPos = this.reader.fileSize - lastWord;
                if (potentialMfraPos >= 0 && potentialMfraPos <= this.reader.fileSize - _isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .MAX_BOX_HEADER_SIZE */ .Xk) {
                    let mfraHeaderSlice = this.reader.requestSliceRange(potentialMfraPos, _isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_BOX_HEADER_SIZE */ .ZM, _isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .MAX_BOX_HEADER_SIZE */ .Xk);
                    if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(mfraHeaderSlice))
                        mfraHeaderSlice = await mfraHeaderSlice;
                    if (mfraHeaderSlice) {
                        const boxInfo = (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readBoxHeader */ .Vl)(mfraHeaderSlice);
                        if (boxInfo && boxInfo.name === 'mfra') {
                            ...
                            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(mfraSlice))
    ...
    async copyMetadataFromInitInput(initInput) {
        ...
        for (const foreignTrack of initDemuxer.tracks) {
            ...
            if (foreignTrack.trackBacking) {
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.info);
    ...
    getSampleTableForTrack(internalTrack) {
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(this.moovSlice);
        ...
        const isPcmCodec = internalTrack.info?.type === 'audio'
            ...
            && _codec_js__WEBPACK_IMPORTED_MODULE_1__/* .PCM_AUDIO_CODECS */ .Wq.includes(internalTrack.info.codec);
        if (isPcmCodec && sampleTable.sampleCompositionTimeOffsets.length === 0) {
            ...
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(internalTrack.info?.type === 'audio');
            const pcmInfo = (0,_codec_js__WEBPACK_IMPORTED_MODULE_1__/* .parsePcmCodec */ .Ei)(internalTrack.info.codec);
            ...
            for (let i = 0; i < sampleTable.sampleToChunk.length; i++) {
                ...
                for (let j = 0; j < chunkCount; j++) {
                    ...
                    const startTimingEntryIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(sampleTable.sampleTimingEntries, startSampleIndex, x => x.startIndex);
                    const startTimingEntry = sampleTable.sampleTimingEntries[startTimingEntryIndex];
                    const endTimingEntryIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(sampleTable.sampleTimingEntries, endSampleIndex, x => x.startIndex);
                    ...
                    const lastSampleTimingEntry = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .last */ ._g)(newSampleTimingEntries);
    ...
    async readFragment(startPos) {
        ...
        let headerSlice = this.reader.requestSliceRange(startPos, _isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_BOX_HEADER_SIZE */ .ZM, _isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .MAX_BOX_HEADER_SIZE */ .Xk);
        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(headerSlice))
            headerSlice = await headerSlice;
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(headerSlice);
        const moofBoxInfo = (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readBoxHeader */ .Vl)(headerSlice);
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(moofBoxInfo?.name === 'moof');
        let entireSlice = this.reader.requestSlice(startPos, moofBoxInfo.totalSize);
        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(entireSlice))
            entireSlice = await entireSlice;
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(entireSlice);
        this.traverseBox(entireSlice);
        const fragment = this.lastReadFragment;
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(fragment && fragment.moofOffset === startPos);
        for (const [, trackData] of fragment.trackData) {
            ...
            if (!trackData.startTimestampIsFinal) {
                ...
                if (lookupEntry) {
                    ...
                    const lastCacheIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(fragmentPositionCache, fragment.moofOffset - 1, x => x.moofOffset);
                    if (lastCacheIndex !== -1) {
            ...
            // lookup table exists
            const insertionIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(fragmentPositionCache, trackData.startTimestamp, x => x.startTimestamp);
            if (insertionIndex === -1
    ...
    readContiguousBoxes(slice) {
        ...
        while (slice.filePos - startIndex <= slice.length - _isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_BOX_HEADER_SIZE */ .ZM) {
    ...
    *iterateContiguousBoxes(slice) {
    ...
    traverseBox(slice) {
        ...
        switch (boxInfo.name) {
            ...
            case 'mvhd':
                {
                    const version = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    slice.skip(3); // Flags
                    if (version === 1) {
                        slice.skip(8 + 8);
                        this.movieTimescale = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        this.movieDurationInTimescale = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU64Be */ .th)(slice);
                    }
                    else {
                        slice.skip(4 + 4);
                        this.movieTimescale = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        this.movieDurationInTimescale = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    }
                }
                ;
                break;
            case 'trak':
                {
                    const track = {
                        ...
                        trackBacking: null,
                        disposition: {
                            ..._metadata_js__WEBPACK_IMPORTED_MODULE_9__/* .DEFAULT_TRACK_DISPOSITION */ .gM,
                            primary: false,
                        },
                        info: null,
                        timescale: -1,
                        ...
                        name: null,
                        languageCode: _misc_js__WEBPACK_IMPORTED_MODULE_4__/* .UNDETERMINED_LANGUAGE */ .IR,
            ...
            case 'tkhd':
                {
                    ...
                    const version = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    const flags = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU24Be */ .n2)(slice);
                    ...
                    if (version === 0) {
                        slice.skip(8);
                        track.id = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        slice.skip(4);
                        track.durationInMovieTimescale = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    }
                    else if (version === 1) {
                        slice.skip(16);
                        track.id = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        slice.skip(4);
                        track.durationInMovieTimescale = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU64Be */ .th)(slice);
                    }
                    else {
                    ...
                    const matrix = [
                        (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readFixed_16_16 */ .vX)(slice),
                        (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readFixed_16_16 */ .vX)(slice),
                        (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readFixed_2_30 */ .IS)(slice),
                        (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readFixed_16_16 */ .vX)(slice),
                        (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readFixed_16_16 */ .vX)(slice),
                        (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readFixed_2_30 */ .IS)(slice),
                        (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readFixed_16_16 */ .vX)(slice),
                    ...
                    const rotation = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .normalizeRotation */ .qT)((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .roundToMultiple */ ["in"])(extractRotationFromMatrix(matrix), 90));
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(rotation === 0 || rotation === 90 || rotation === 180 || rotation === 270);
            ...
            case 'elst':
                {
                    ...
                    const entryCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    for (let i = 0; i < entryCount; i++) {
                        const segmentDuration = version === 1
                            ? (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU64Be */ .th)(slice)
                            : (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        const mediaTime = version === 1
                            ? (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readI64Be */ .B5)(slice)
                            : (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readI32Be */ .Ar)(slice);
                        const mediaRate = (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readFixed_16_16 */ .vX)(slice);
                        if (segmentDuration === 0) {
                            // Don't care
                            continue;
                        }
                        if (relevantEntryFound) {
                            _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn('Unsupported edit list: multiple edits are not currently supported. Only using first edit.');
                            break;
                        }
                        if (mediaTime === -1) {
                        ...
                        if (mediaRate !== 1) {
                            _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn('Unsupported edit list entry: media rate must be 1.');
                            break;
                        }
            ...
            case 'mdhd':
                {
                    ...
                    if (version === 0) {
                        slice.skip(8);
                        track.timescale = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        track.durationInMediaTimescale = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    }
                    else if (version === 1) {
                        slice.skip(16);
                        track.timescale = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        track.durationInMediaTimescale = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU64Be */ .th)(slice);
                    }
                    let language = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH)(slice);
                    if (language > 0) {
                        track.languageCode = '';
                        for (let i = 0; i < 3; i++) {
                        ...
                        if (!(0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isIso639Dash2LanguageCode */ .Nu)(track.languageCode)) {
                            // Sometimes the bytes are garbage
                            track.languageCode = _misc_js__WEBPACK_IMPORTED_MODULE_4__/* .UNDETERMINED_LANGUAGE */ .IR;
                        }
                    }
                }
                ;
            ...
            case 'hdlr':
                {
                    ...
                    const handlerType = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readAscii */ .IT)(slice, 4);
                    if (handlerType === 'vide') {
                        track.info = {
                            type: 'video',
                            width: -1,
                            ...
                            colorSpace: { ..._misc_js__WEBPACK_IMPORTED_MODULE_4__/* .EMPTY_COLOR_SPACE */ .jW },
                            avcType: null,
                            avcCodecInfo: null,
                            hevcCodecInfo: null,
                            vp9CodecInfo: null,
            ...
            case 'stsd':
                {
                    ...
                    const stsdVersion = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    slice.skip(3); // Flags
                    const entries = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    for (let i = 0; i < entries; i++) {
                        const sampleBoxStartPos = slice.filePos;
                        const sampleBoxInfo = (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readBoxHeader */ .Vl)(slice);
                        if (!sampleBoxInfo) {
                            break;
                        }
                        ...
                        if (track.info.type === 'video') {
                            ...
                            track.info.width = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH)(slice);
                            track.info.height = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH)(slice);
                            ...
                            else if (_codec_js__WEBPACK_IMPORTED_MODULE_1__/* .PRORES_FOURCCS */ .Y2.includes(lowercaseBoxName)) {
                                track.info.codec = 'prores';
                                track.info.proresFormat = lowercaseBoxName;
                            }
                            else if (codecName === null) {
                                _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn(`Unknown encrypted video codec due to missing frma box.`);
                            }
                            else {
                                _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn(`Unsupported video codec (sample entry type '${sampleBoxInfo.name}').`);
                            }
                        }
                        else {
                            slice.skip(6 * 1 + 2);
                            const version = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH)(slice);
                            slice.skip(3 * 2);
                            let channelCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH)(slice);
                            let sampleSize = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH)(slice);
                            slice.skip(2 * 2);
                            // Can't use fixed16_16 as that's signed
                            let sampleRate = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice) / 0x10000;
                            let lpcmFlags = null;
                            if (stsdVersion === 0 && version > 0) {
                                // Additional QuickTime fields
                                if (version === 1) {
                                    slice.skip(4);
                                    sampleSize = 8 * (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                                    slice.skip(2 * 4);
                                }
                                else if (version === 2) {
                                    slice.skip(4);
                                    sampleRate = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readF64Be */ ._3)(slice);
                                    channelCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                                    slice.skip(4); // Always 0x7f000000
                                    sampleSize = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                                    lpcmFlags = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                                    slice.skip(2 * 4);
                                }
                            }
                            ...
                            if (codecName === 'mp4a') {
                                ...
                                track.info.sampleRate = _codec_js__WEBPACK_IMPORTED_MODULE_1__/* .OPUS_SAMPLE_RATE */ .yo; // Always the same
                            }
                            ...
                            else if (_codec_js__WEBPACK_IMPORTED_MODULE_1__/* .DTS_FOURCCS */ .Sf.includes(codecName)) {
                                ...
                                if (sampleSize === 8) {
                                    ...
                                    _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn(`Unsupported sample size ${sampleSize} for codec 'twos'.`);
                                ...
                                if (sampleSize === 8) {
                                    ...
                                    _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn(`Unsupported sample size ${sampleSize} for codec 'sowt'.`);
                                    track.info.codec = null;
                                }
                            }
                                ...
                                if (track.info.pcmLittleEndian) {
                                    if (pcmSampleSize === 16) {
                                        ...
                                        _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn(`Invalid ipcm sample size ${pcmSampleSize}.`);
                                        track.info.codec = null;
                                    }
                                }
                                else {
                                ...
                                if (track.info.pcmLittleEndian) {
                                    if (pcmSampleSize === 32) {
                                        ...
                                        _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn(`Invalid fpcm sample size ${pcmSampleSize}.`);
                                        track.info.codec = null;
                                    }
                                }
                                else {
                                ...
                                if (track.info.codec === null) {
                                    _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn('Unsupported PCM format.');
                                }
                            }
                            else if (codecName === null) {
                                _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn(`Unknown encrypted audio codec due to missing frma box.`);
                            }
                            else {
                                _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn(`Unsupported audio codec (sample entry type '${sampleBoxInfo.name}').`);
                            }
                        }
            ...
            case 'frma':
                {
                    ...
                    const format = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readAscii */ .IT)(slice, 4);
            ...
            case 'schm':
                {
                    ...
                    const schemeType = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readAscii */ .IT)(slice, 4);
                    if (schemeType === 'cenc' || schemeType === 'cens' || schemeType === 'cbcs') {
                        ...
                        _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn(`Unsupported encryption scheme '${schemeType}'.`);
                    }
                }
                ;
                break;
            case 'tenc':
                {
                    ...
                    const patternByte = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    if (version > 0) {
                    ...
                    track.encryptionInfo.defaultIsProtected = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice) !== 0;
                    track.encryptionInfo.defaultPerSampleIvSize = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    track.encryptionInfo.defaultKid = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .bytesToHexString */ .Br)((0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, 16));
                    if (track.encryptionInfo.defaultIsProtected && track.encryptionInfo.defaultPerSampleIvSize === 0) {
                        const constantIvSize = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                        const constantIv = new Uint8Array(16);
                        constantIv.set((0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, constantIvSize), 0);
            ...
            case 'avcC':
                {
                    ...
                    track.info.codecDescription = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, boxInfo.contentSize);
                }
                ;
                break;
            case 'hvcC':
            ...
            case 'vpcC':
                {
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.info?.type === 'video');
                    slice.skip(4); // Version + flags
                    const profile = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    const level = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    const thirdByte = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    const bitDepth = thirdByte >> 4;
                    const chromaSubsampling = (thirdByte >> 1) & 0b111;
                    const videoFullRangeFlag = thirdByte & 1;
                    const colourPrimaries = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    const transferCharacteristics = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    const matrixCoefficients = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
            ...
            case 'av1C':
                {
                    ...
                    const secondByte = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    ...
                    const configObus = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, boxInfo.contentSize - 4);
                    const configObuInfo = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .extractAv1CodecInfoFromPacket */ .UU)(configObus);
            ...
            case 'colr':
                {
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.info?.type === 'video');
                    const colourType = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readAscii */ .IT)(slice, 4);
                    if (colourType !== 'nclx' && colourType !== 'nclc') {
                        break;
                    }
                    const colourPrimaries = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH)(slice);
                    const transferCharacteristics = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH)(slice);
                    const matrixCoefficients = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH)(slice);
                    let fullRange = undefined;
                    if (colourType === 'nclx') {
                        fullRange = Boolean((0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice) & 0x80);
                    }
                    track.info.colorSpace = {
                        primaries: _misc_js__WEBPACK_IMPORTED_MODULE_4__/* .COLOR_PRIMARIES_MAP_INVERSE */ .BL[colourPrimaries],
                        transfer: _misc_js__WEBPACK_IMPORTED_MODULE_4__/* .TRANSFER_CHARACTERISTICS_MAP_INVERSE */ .x_[transferCharacteristics],
                        matrix: _misc_js__WEBPACK_IMPORTED_MODULE_4__/* .MATRIX_COEFFICIENTS_MAP_INVERSE */ .fl[matrixCoefficients],
                        fullRange,
                    };
                }
                ;
            ...
            case 'pasp':
                {
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.info?.type === 'video');
                    const num = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    const den = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
            ...
            case 'esds':
                {
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.info?.type === 'audio');
                    slice.skip(4); // Version + flags
                    const tag = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(tag === 0x03); // ES Descriptor
                    (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readIsomVariableInteger */ .hs)(slice); // Length
                    slice.skip(2); // ES ID
                    const mixed = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    ...
                    if (urlFlag) {
                        const urlLength = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                        slice.skip(urlLength);
                    }
                    if (ocrStreamFlag) {
                        slice.skip(2);
                    }
                    const decoderConfigTag = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(decoderConfigTag === 0x04); // DecoderConfigDescriptor
                    const decoderConfigDescriptorLength = (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readIsomVariableInteger */ .hs)(slice); // Length
                    const payloadStart = slice.filePos;
                    const objectTypeIndication = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    if (objectTypeIndication === 0x40 || objectTypeIndication === 0x67) {
                        ...
                        _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn(`Unsupported audio codec (objectTypeIndication ${objectTypeIndication}) - discarding track.`);
                    }
                    slice.skip(1 + 3 + 4 + 4);
                    if (decoderConfigDescriptorLength > slice.filePos - payloadStart) {
                        // There's a DecoderSpecificInfo at the end, let's read it
                        const decoderSpecificInfoTag = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(decoderSpecificInfoTag === 0x05); // DecoderSpecificInfo
                        const decoderSpecificInfoLength = (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readIsomVariableInteger */ .hs)(slice);
                        track.info.codecDescription = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, decoderSpecificInfoLength);
                        if (track.info.codec === 'aac') {
                            // Let's try to deduce more accurate values directly from the AudioSpecificConfig:
                            const audioSpecificConfig = (0,_shared_aac_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .parseAacAudioSpecificConfig */ .zF)(track.info.codecDescription);
            ...
            case 'enda':
                {
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.info?.type === 'audio');
                    track.info.pcmLittleEndian = !!((0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH)(slice) & 0xff); // 0xff is from FFmpeg
                }
                ;
                break;
            case 'pcmC':
                {
                    ...
                    // ISO/IEC 23003-5
                    const formatFlags = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    track.info.pcmLittleEndian = Boolean(formatFlags & 0x01);
                    track.info.pcmSampleSize = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                }
                ;
                break;
            case 'dOps':
                { // Used for Opus audio
                    ...
                    const outputChannelCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    const preSkip = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH)(slice);
                    const inputSampleRate = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    const outputGain = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readI16Be */ .iH)(slice);
                    const channelMappingFamily = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    let channelMappingTable;
                    if (channelMappingFamily !== 0) {
                        channelMappingTable = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, 2 + outputChannelCount);
                    }
                    else {
            ...
            case 'dfLa':
                { // Used for FLAC audio
                    ...
                    while (slice.filePos < boxEndPos) {
                        const flagAndType = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                        const metadataBlockLength = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU24Be */ .n2)(slice);
                        const type = flagAndType & BLOCK_TYPE_MASK;
                        // It's a STREAMINFO block; let's extract the actual sample rate and channel count
                        if (type === _codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .FlacBlockType */ .A3.STREAMINFO) {
                            slice.skip(10);
                            // Extract sample rate and channel count
                            const word = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    ...
                    const bytes = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, endPos - startPos);
            ...
            case 'dac3':
                { // AC3SpecificBox
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.info?.type === 'audio');
                    const bytes = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, 3);
                    const bitstream = new _shared_bitstream_js__WEBPACK_IMPORTED_MODULE_11__/* .Bitstream */ ._(bytes);
                    ...
                    if (fscod < 3) {
                        track.info.sampleRate = _shared_ac3_misc_js__WEBPACK_IMPORTED_MODULE_10__/* .AC3_SAMPLE_RATES */ .N[fscod];
                    }
                    track.info.numberOfChannels = _codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .AC3_ACMOD_CHANNEL_COUNTS */ .ux[acmod] + lfeon;
                }
                ;
                break;
            case 'dec3':
                { // EC3SpecificBox
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.info?.type === 'audio');
                    const bytes = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, boxInfo.contentSize);
                    const config = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .parseEac3Config */ .Sd)(bytes);
                    if (!config) {
                        _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn('Invalid dec3 box contents, ignoring.');
                        break;
                    }
                    const sampleRate = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .getEac3SampleRate */ .PK)(config);
                    if (sampleRate !== null) {
                        track.info.sampleRate = sampleRate;
                    }
                    track.info.numberOfChannels = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .getEac3ChannelCount */ .zV)(config);
                }
                ;
                break;
            case 'ddts':
                { // DTSSpecificBox
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.info?.type === 'audio');
                    const bytes = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, Math.min(boxInfo.contentSize, _codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .DTS_SPECIFIC_BOX_SIZE */ .Xc));
                    const config = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .parseDtsSpecificBox */ .ix)(bytes);
                    if (!config) {
                        _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn('Invalid ddts box contents, ignoring.');
                        break;
                    }
            ...
            case 'stts':
                {
                    ...
                    for (let i = 0; i < entryCount; i++) {
                        const sampleCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        const sampleDelta = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
            ...
            case 'ctts':
                {
                    ...
                    for (let i = 0; i < entryCount; i++) {
                        const sampleCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        const sampleOffset = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readI32Be */ .Ar)(slice);
            ...
            case 'stsz':
                {
                    ...
                    slice.skip(4); // Version + flags
                    const sampleSize = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    const sampleCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    if (sampleSize === 0) {
            ...
            case 'stz2':
                {
                    ...
                    const fieldSize = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice); // in bits
                    const sampleCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    const bytes = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, Math.ceil(sampleCount * fieldSize / 8));
                    const bitstream = new _shared_bitstream_js__WEBPACK_IMPORTED_MODULE_11__/* .Bitstream */ ._(bytes);
                    for (let i = 0; i < sampleCount; i++) {
            ...
            case 'stss':
                {
                    ...
                    const entryCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    for (let i = 0; i < entryCount; i++) {
                        const sampleIndex = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice) - 1; // Convert to 0-indexed
            ...
            case 'stsc':
                {
                    ...
                    const entryCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    for (let i = 0; i < entryCount; i++) {
                        const startChunkIndex = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice) - 1; // Convert to 0-indexed
                        const samplesPerChunk = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        const sampleDescriptionIndex = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
            ...
            case 'stco':
                {
                    ...
                    const entryCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    for (let i = 0; i < entryCount; i++) {
                        const chunkOffset = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
            ...
            case 'co64':
                {
                    ...
                    const entryCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    for (let i = 0; i < entryCount; i++) {
                        const chunkOffset = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU64Be */ .th)(slice);
                        track.sampleTable.chunkOffsets.push(chunkOffset);
                    }
                }
                ;
            ...
            case 'mehd':
                {
                    const version = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    slice.skip(3); // Flags
                    const fragmentDuration = version === 1 ? (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU64Be */ .th)(slice) : (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
            ...
            case 'trex':
                {
                    slice.skip(4); // Version + flags
                    const trackId = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    const defaultSampleDescriptionIndex = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    const defaultSampleDuration = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    const defaultSampleSize = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    const defaultSampleFlags = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
            ...
            case 'tfra':
                {
                    ...
                    const functions = [_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo, _reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH, _reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU24Be */ .n2, _reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN];
                    const readTrafNum = functions[lengthSizeOfTrafNum];
                    const readTrunNum = functions[lengthSizeOfTrunNum];
                    const readSampleNum = functions[lengthSizeOfSampleNum];
                    const numberOfEntries = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    for (let i = 0; i < numberOfEntries; i++) {
                        const time = version === 1 ? (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU64Be */ .th)(slice) : (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        const moofOffset = version === 1 ? (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU64Be */ .th)(slice) : (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        readTrafNum(slice);
                        readTrunNum(slice);
                        readSampleNum(slice);
            ...
            case 'traf':
                {
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(this.currentFragment);
                    this.readContiguousBoxes(slice.slice(contentStartPos, boxInfo.contentSize));
                    ...
                    if (this.currentTrack) {
                        ...
                        cond: if (trackData) {
                            ...
                            const lastSample = trackData.samples[(0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .last */ ._g)(trackData.presentationTimestamps).sampleIndex];
                            trackData.startTimestamp = firstSample.presentationTimestamp;
                            trackData.endTimestamp = lastSample.presentationTimestamp + lastSample.duration;
                            const { currentFragmentState } = this.currentTrack;
                            (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(currentFragmentState);
            ...
            case 'pssh':
                {
                    ...
                    const psshBox = (0,_isobmff_misc_js__WEBPACK_IMPORTED_MODULE_6__/* .parsePsshBoxContents */ .j1)((0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, boxInfo.contentSize));
            ...
            case 'tfhd':
                {
                    ...
                    if (baseDataOffsetPresent) {
                        track.currentFragmentState.baseDataOffset = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU64Be */ .th)(slice);
                    }
                    else if (defaultBaseIsMoof) {
                        track.currentFragmentState.baseDataOffset = this.currentFragment.moofOffset;
                    }
                    if (sampleDescriptionIndexPresent) {
                        track.currentFragmentState.sampleDescriptionIndex = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    }
                    if (defaultSampleDurationPresent) {
                        track.currentFragmentState.defaultSampleDuration = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    }
                    if (defaultSampleSizePresent) {
                        track.currentFragmentState.defaultSampleSize = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    }
                    if (defaultSampleFlagsPresent) {
                        track.currentFragmentState.defaultSampleFlags = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    }
                    if (durationIsEmpty) {
            ...
            case 'tfdt':
                {
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.currentFragmentState);
                    const version = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    slice.skip(3); // Flags
                    const baseMediaDecodeTime = version === 0 ? (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice) : (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU64Be */ .th)(slice);
            ...
            case 'trun':
                {
                    ...
                    if (dataOffsetPresent) {
                        dataOffset = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readI32Be */ .Ar)(slice);
                    }
                    let firstSampleFlags = null;
                    if (firstSampleFlagsPresent) {
                        firstSampleFlags = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    }
                    let trackData;
                    ...
                    for (let i = 0; i < sampleCount; i++) {
                        ...
                        if (sampleDurationPresent) {
                            sampleDuration = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        }
                        else {
                            (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.currentFragmentState.defaultSampleDuration !== null);
                        ...
                        if (sampleSizePresent) {
                            ...
                            (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.currentFragmentState.defaultSampleSize !== null);
                            sampleSize = track.currentFragmentState.defaultSampleSize;
                        }
                        let sampleFlags;
                        if (sampleFlagsPresent) {
                            sampleFlags = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        }
                        else {
                            (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.currentFragmentState.defaultSampleFlags !== null);
                        ...
                        if (sampleCompositionTimeOffsetsPresent) {
                            if (version === 0) {
                                sampleCompositionTimeOffset = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                            }
                            else {
                                sampleCompositionTimeOffset = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readI32Be */ .Ar)(slice);
                            }
                        }
            ...
            case 'saiz':
                {
                    ...
                    const flags = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU24Be */ .n2)(slice);
                    if (flags & 0x01) {
                        const auxInfoType = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readAscii */ .IT)(slice, 4);
                        const auxInfoTypeParam = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        if (auxInfoType !== track.encryptionInfo.scheme || auxInfoTypeParam !== 0) {
                            // Not the encryption aux info
                            break;
                        }
                    }
                    const defaultSampleInfoSize = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU8 */ .eo)(slice);
                    const sampleCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    let sampleSizes = null;
                    if (defaultSampleInfoSize === 0 && sampleCount > 0) {
                        sampleSizes = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, sampleCount);
                    }
            ...
            case 'saio':
                {
                    ...
                    if (entryCount > 1) {
                        _logging_js__WEBPACK_IMPORTED_MODULE_13__/* .Logging */ .y._warn('Multiple saio entries are not supported; using the first offset only.');
                    }
                    let offset = version === 0 ? (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice) : Number((0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU64Be */ .th)(slice));
            ...
            case 'senc':
                {
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(ivSize !== null);
                    for (let i = 0; i < Math.min(sampleCount, trackData.samples.length); i++) {
                        ...
                        if (ivSize > 0) {
                            iv.set((0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, ivSize), 0);
                        }
                        else {
                        ...
                        let subsamples = null;
                        if (useSubsamples) {
                            const subsampleCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH)(slice);
                            subsamples = [];
                            for (let j = 0; j < subsampleCount; j++) {
                                const clearLen = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU16Be */ .mH)(slice);
                                const protectedLen = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    ...
                    for (const { boxInfo, slice } of iterator) {
                        if (boxInfo.name !== 'meta' && !this.currentTrack) {
                            ...
                            if (boxInfo.name[0] === '©') {
                                ...
                                this.metadataTags.raw[boxInfo.name] ??= (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readMetadataStringShort */ .$L)(slice);
                            }
                            else {
                                this.metadataTags.raw[boxInfo.name] ??= (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, boxInfo.contentSize);
                            }
                            slice.filePos = startPos;
                        }
                        switch (boxInfo.name) {
                            ...
                            case 'name':
                                {
                                    if (this.currentTrack) {
                                        this.currentTrack.name = _misc_js__WEBPACK_IMPORTED_MODULE_4__/* .textDecoder */ .su.decode((0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, boxInfo.contentSize));
                                    }
                                    else {
                                        this.metadataTags.title ??= (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readMetadataStringShort */ .$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case '©des':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.description ??= (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readMetadataStringShort */ .$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case '©ART':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.artist ??= (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readMetadataStringShort */ .$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case '©alb':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.album ??= (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readMetadataStringShort */ .$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case 'albr':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.albumArtist ??= (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readMetadataStringShort */ .$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case '©gen':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.genre ??= (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readMetadataStringShort */ .$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case '©day':
                                {
                                    if (!this.currentTrack) {
                                        const date = new Date((0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readMetadataStringShort */ .$L)(slice));
                            ...
                            case '©cmt':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.comment ??= (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readMetadataStringShort */ .$L)(slice);
                                    }
                                }
                                ;
                                break;
                            case '©lyr':
                                {
                                    if (!this.currentTrack) {
                                        this.metadataTags.lyrics ??= (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readMetadataStringShort */ .$L)(slice);
                                    }
                                }
                                ;
                                break;
            ...
            case 'keys':
                {
                    ...
                    const entryCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                    for (let i = 0; i < entryCount; i++) {
                        const keySize = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readU32Be */ .cN)(slice);
                        slice.skip(4); // Key namespace
                        const keyName = _misc_js__WEBPACK_IMPORTED_MODULE_4__/* .textDecoder */ .su.decode((0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, keySize - 8));
            ...
            case 'ilst':
                {
                    ...
                    for (const { boxInfo, slice } of iterator) {
                        ...
                        const data = (0,_isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readDataBox */ .Cp)(slice);
                        this.metadataTags.raw ??= {};
                        ...
                        switch (metadataKey) {
                            ...
                            case 'com.apple.quicktime.artwork':
                                {
                                    if (data instanceof _metadata_js__WEBPACK_IMPORTED_MODULE_9__/* .RichImageData */ .sF) {
                                        this.metadataTags.images ??= [];
                                        this.metadataTags.images.push({
                                            data: data.data,
                                            kind: 'coverFront',
                            ...
                            case 'trkn':
                                {
                                    if (data instanceof Uint8Array && data.length >= 6) {
                                        const view = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .toDataView */ .Zc)(data);
...
class IsobmffTrackBacking {
    ...
    async getDurationFromMetadata() {
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.trackBacking);
    ...
    mapTimestampIntoTimescale(timestamp) {
        ...
        return (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .roundIfAlmostInteger */ .aI)(timestamp * this.internalTrack.timescale) + this.internalTrack.editListOffset;
    }
    async getPacket(timestamp, options) {
        ...
        return this.performFragmentedLookup(null, (fragment) => {
            ...
            const index = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(trackData.presentationTimestamps, timestampInTimescale, x => x.presentationTimestamp);
    ...
    async getKeyPacket(timestamp, options) {
        ...
        return this.performFragmentedLookup(null, (fragment) => {
            ...
            const index = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .findLastIndex */ .Kl)(trackData.presentationTimestamps, (x) => {
        ...
        return this.performFragmentedLookup(locationInFragment.fragment, (fragment) => {
            if (fragment === locationInFragment.fragment) {
                ...
                if (trackData && trackData.firstKeyFrameTimestamp !== null) {
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(keyFrameIndex !== -1); // There must be one
                    return {
    ...
    async fetchPacketForSampleIndex(sampleIndex, options) {
        ...
        if (options.metadataOnly) {
            ...
            data = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, sampleInfo.sampleSize);
        ...
        const packet = new _packet_js__WEBPACK_IMPORTED_MODULE_5__/* .EncodedPacket */ .Z(data, sampleInfo.isKeyFrame ? 'key' : 'delta', timestamp, duration, sampleIndex, sampleInfo.sampleSize);
    ...
    async fetchPacketInFragment(fragment, sampleIndex, options) {
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(fragmentSample);
        let data;
        if (options.metadataOnly) {
            data = _packet_js__WEBPACK_IMPORTED_MODULE_5__/* .PLACEHOLDER_DATA */ .T;
        }
            ...
            data = (0,_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readBytes */ .io)(slice, fragmentSample.byteSize);
            if (this.internalTrack.encryptionInfo) {
        ...
        const packet = new _packet_js__WEBPACK_IMPORTED_MODULE_5__/* .EncodedPacket */ .Z(data, fragmentSample.isKeyFrame ? 'key' : 'delta', timestamp, duration, fragment.moofOffset + sampleIndex, fragmentSample.byteSize);
    ...
    latestTimestamp, options) {
        ...
        const lookupEntryIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(this.internalTrack.fragmentLookupTable, searchTimestamp, x => x.timestamp);
        const lookupEntry = lookupEntryIndex !== -1
            ? this.internalTrack.fragmentLookupTable[lookupEntryIndex]
            : null;
        const positionCacheIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(this.internalTrack.fragmentPositionCache, searchTimestamp, x => x.startTimestamp);
        ...
        while (true) {
            ...
            // Load the header
            let slice = demuxer.reader.requestSliceRange(currentPos, _isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_BOX_HEADER_SIZE */ .ZM, _isobmff_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .MAX_BOX_HEADER_SIZE */ .Xk);
            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(slice))
                slice = await slice;
            if (!slice)
                break;
        ...
        if (lookupEntry && (!bestFragment || bestFragment.moofOffset < lookupEntry.moofOffset)) {
            ...
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(!previousLookupEntry || previousLookupEntry.timestamp < lookupEntry.timestamp);
        ...
        return this.decoderConfigPromise ??= (async () => {
            if (this.internalTrack.info.codec === 'avc' && !this.internalTrack.info.codecDescription) {
                ...
                this.internalTrack.info.avcCodecInfo
                    = firstPacket && (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .extractAvcDecoderConfigurationRecord */ .fH)(firstPacket.data);
            }
            else if (this.internalTrack.info.codec === 'hevc' && !this.internalTrack.info.codecDescription) {
                const firstPacket = await this.getFirstPacket({});
                this.internalTrack.info.hevcCodecInfo
                    = firstPacket && (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .extractHevcDecoderConfigurationRecord */ .D5)(firstPacket.data);
            }
                ...
                && (!this.internalTrack.info.vp9CodecInfo
                    ...
                    || !(0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .vp9CodecInfoHasColorInfo */ .$m)(this.internalTrack.info.vp9CodecInfo))) {
                const firstPacket = await this.getFirstPacket({});
                const packetInfo = firstPacket && (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .extractVp9CodecInfoFromPacket */ .bs)(firstPacket.data);
                if (packetInfo) {
                    this.internalTrack.info.vp9CodecInfo = {
                ...
                && (!this.internalTrack.info.av1CodecInfo
                    ...
                    || !(0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .av1CodecInfoHasColorInfo */ .et)(this.internalTrack.info.av1CodecInfo))) {
                const firstPacket = await this.getFirstPacket({});
                const packetInfo = firstPacket && (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .extractAv1CodecInfoFromPacket */ .UU)(firstPacket.data);
                if (packetInfo) {
                ...
                this.internalTrack.info.proresCodecInfo
                    = firstPacket && (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .extractProresCodecInfoFromPacket */ .RU)(firstPacket.data);
            }
            if (!(0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .colorSpaceIsComplete */ .HV)(this.internalTrack.info.colorSpace)) {
                const colorSpace = (0,_codec_js__WEBPACK_IMPORTED_MODULE_1__/* .extractColorSpace */ .LD)(this.internalTrack.info);
            ...
            const config = {
                codec: (0,_codec_js__WEBPACK_IMPORTED_MODULE_1__/* .extractVideoCodecString */ .QP)(this.internalTrack.info),
    ...
    async getDecoderConfig() {
        ...
        return this.decoderConfigPromise ??= (async () => {
            if (this.internalTrack.info.codec === 'dts' && !this.internalTrack.info.dtsFormat) {
                ...
                const firstPacket = await this.getFirstPacket({});
                this.internalTrack.info.dtsFormat = firstPacket && (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_2__/* .extractDtsFourCcFromPacket */ .n$)(firstPacket.data);
            }
            return {
                codec: (0,_codec_js__WEBPACK_IMPORTED_MODULE_1__/* .extractAudioCodecString */ .X0)(this.internalTrack.info),
...
const getSampleIndexForTimestamp = (sampleTable, timescaleUnits) => {
    if (sampleTable.presentationTimestamps) {
        const index = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(sampleTable.presentationTimestamps, timescaleUnits, x => x.presentationTimestamp);
        if (index === -1) {
            return -1;
        }
        ...
        const index = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(sampleTable.sampleTimingEntries, timescaleUnits, x => x.startDecodeTimestamp);
        if (index === -1) {
            return -1;
        }
...
const getKeyframeSampleIndexForTimestamp = (sampleTable, timescaleUnits) => {
    ...
    if (sampleTable.presentationTimestamps) {
        ...
        for (let i = index; i >= 0; i--) {
            ...
            const isKeyFrame = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchExact */ .pl)(sampleTable.keySampleIndices, sampleIndex, x => x) !== -1;
            if (isKeyFrame) {
                return sampleIndex;
            }
        }
        ...
        const index = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(sampleTable.keySampleIndices, sampleIndex, x => x);
        return sampleTable.keySampleIndices[index] ?? -1;
    }
};
const getSampleInfo = (sampleTable, sampleIndex) => {
    const timingEntryIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(sampleTable.sampleTimingEntries, sampleIndex, x => x.startIndex);
    ...
    const offsetEntryIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(sampleTable.sampleCompositionTimeOffsets, sampleIndex, x => x.startIndex);
    const offsetEntry = sampleTable.sampleCompositionTimeOffsets[offsetEntryIndex];
    if (offsetEntry && sampleIndex - offsetEntry.startIndex < offsetEntry.count) {
        presentationTimestamp += offsetEntry.offset;
    }
    const sampleSize = sampleTable.sampleSizes[Math.min(sampleIndex, sampleTable.sampleSizes.length - 1)];
    const chunkEntryIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(sampleTable.sampleToChunk, sampleIndex, x => x.startSampleIndex);
    const chunkEntry = sampleTable.sampleToChunk[chunkEntryIndex];
    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(chunkEntry);
    ...
    if (sampleTable.presentationTimestamps) {
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(presentationIndex !== undefined);
    ...
    return {
        ...
        isKeyFrame: sampleTable.keySampleIndices
            ? (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchExact */ .pl)(sampleTable.keySampleIndices, sampleIndex, x => x) !== -1
            : true,
    };
};
...
const resolveEncryptionAuxInfo = async (reader, encryptionInfo, aux) => {
    ...
    if (aux.defaultSampleInfoSize > 0) {
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(aux.sampleSizes);
...
const decryptSample = async (track, sampleEncryption, data, fragment) => {
    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(track.encryptionInfo);
    const encryptionInfo = track.encryptionInfo;
    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(encryptionInfo.defaultKid !== null);
    ...
    if (cacheEntry) {
        ...
        const promise = (async () => {
            ...
            if (fragment) {
                ...
                for (let i = 0; i < psshBoxes.length - 1; i++) {
                    for (let j = i + 1; j < psshBoxes.length; j++) {
                        if ((0,_isobmff_misc_js__WEBPACK_IMPORTED_MODULE_6__/* .psshBoxesAreEqual */ .MG)(psshBoxes[i], psshBoxes[j])) {
            ...
            if (!((typeof keyResult === 'string' && keyResult.length === 32 && _misc_js__WEBPACK_IMPORTED_MODULE_4__/* .HEX_STRING_REGEX */ .Sn.test(keyResult))
            ...
            return keyResult instanceof Uint8Array
                ? keyResult
                : (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .hexStringToBytes */ .ZY)(keyResult);
        })();
...
const decryptCtr = async (key, encryptionInfo, sampleEncryption, data) => {
    ...
    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(encryptionInfo.defaultCryptByteBlock !== null && encryptionInfo.defaultSkipByteBlock !== null);
...
const decryptCbcs = (key, encryptionInfo, sampleEncryption, data) => {
    const ctx = new _aes_js__WEBPACK_IMPORTED_MODULE_12__/* .Aes128CbcContext */ .UP();
    ...
    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(cryptByteBlock !== null && skipByteBlock !== null);
    if (!sampleEncryption.subsamples) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   N: () => (/* binding */ MatroskaDemuxer)
/* harmony export */ });
/* harmony import */ var _codec_data_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6297);
/* harmony import */ var _codec_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1188);
/* harmony import */ var _demuxer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7202);
/* harmony import */ var _logging_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6103);
/* harmony import */ var _metadata_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5165);
...
/* harmony import */ var _ebml_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(6411);
/* harmony import */ var _matroska_misc_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(3616);
/* harmony import */ var _reader_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(7735);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
const METADATA_ELEMENTS = [
    { id: _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.SeekHead, flag: 'seekHeadSeen' },
    { id: _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Info, flag: 'infoSeen' },
    { id: _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Tracks, flag: 'tracksSeen' },
    { id: _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Cues, flag: 'cuesSeen' },
];
const MAX_RESYNC_LENGTH = 10 * 2 ** 20; // 10 MiB
class MatroskaDemuxer extends _demuxer_js__WEBPACK_IMPORTED_MODULE_2__/* .Demuxer */ .B {
    constructor(input) {
        super(input);
    ...
    async getMimeType() {
        ...
        const backings = await this.getTrackBackings();
        const codecStrings = await Promise.all(backings.map(x => x.getDecoderConfig().then(c => c?.codec ?? null)));
        return (0,_matroska_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .buildMatroskaMimeType */ .V)({
            isWebM: this.isWebM,
    ...
    readMetadata() {
        return this.readMetadataPromise ??= (async () => {
            ...
            while (true) {
                let slice = this.reader.requestSliceRange(currentPos, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_HEADER_SIZE */ .De, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MAX_HEADER_SIZE */ .r1);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .isThenable */ .Qg)(slice))
                    slice = await slice;
                if (!slice)
                    break;
                const header = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readElementHeader */ .ur)(slice);
                if (!header) {
                ...
                if (id === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.EBML) {
                    (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .assertDefinedSize */ .p)(size);
                ...
                else if (id === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Segment) { // Segment found!
                ...
                else if (id === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Cluster) {
                    if (this.reader.fileSize === null) {
                    ...
                    if (size === undefined) {
                        ...
                        // determine its size.
                        const nextElementPos = await (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .searchForNextElementId */ .IQ)(this.reader, dataStartPos, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .LEVEL_0_AND_1_EBML_IDS */ .K9, this.reader.fileSize);
                        size = nextElementPos.pos - dataStartPos;
                    }
                    const lastSegment = (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .last */ ._g)(this.segments);
                    if (lastSegment) {
    ...
    async readSegment(segmentDataStart, dataSize) {
        ...
        while (this.currentSegment.elementEndPos === null || currentPos < this.currentSegment.elementEndPos) {
            ...
            const header = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readElementHeader */ .ur)(slice);
            if (!header || (!_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .LEVEL_1_EBML_IDS */ .VE.includes(header.id) && header.id !== _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Void)) {
                // Potential junk. Let's try to resync
                const nextPos = await (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .resync */ .nE)(this.reader, elementStartPos, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .LEVEL_1_EBML_IDS */ .VE, Math.min(this.currentSegment.elementEndPos ?? Infinity, elementStartPos + MAX_RESYNC_LENGTH));
                if (nextPos) {
                    currentPos = nextPos;
                    continue;
                }
            ...
            else if (id === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Tags || id === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Attachments) {
                // Metadata found at the beginning of the segment, great, let's parse it
                if (id === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Tags) {
        ...
        if (this.reader.fileSize !== null) {
            ...
            for (const seekEntry of this.currentSegment.seekEntries) {
                ...
                if (this.currentSegment[target.flag])
                    continue;
                let slice = this.reader.requestSliceRange(segmentDataStart + seekEntry.segmentPosition, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_HEADER_SIZE */ .De, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MAX_HEADER_SIZE */ .r1);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .isThenable */ .Qg)(slice))
                    slice = await slice;
                if (!slice)
                    continue;
                ...
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .isThenable */ .Qg)(dataSlice))
    ...
    async readCluster(startPos, segment) {
        ...
        let headerSlice = this.reader.requestSliceRange(startPos, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_HEADER_SIZE */ .De, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MAX_HEADER_SIZE */ .r1);
        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .isThenable */ .Qg)(headerSlice))
            headerSlice = await headerSlice;
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(headerSlice);
        const elementStartPos = startPos;
        const elementHeader = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readElementHeader */ .ur)(headerSlice);
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(elementHeader);
        const id = elementHeader.id;
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(id === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Cluster);
        ...
        if (size === undefined) {
            ...
            const nextElementPos = await (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .searchForNextElementId */ .IQ)(this.reader, dataStartPos, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .LEVEL_0_AND_1_EBML_IDS */ .K9, segment.elementEndPos);
            size = nextElementPos.pos - dataStartPos;
        }
        ...
        if (dataSlice) {
            ...
            const endPos = this.readContiguousElements(dataSlice, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .LEVEL_0_AND_1_EBML_IDS */ .K9);
        ...
        for (const [, trackData] of cluster.trackData) {
            ...
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(trackData.blocks.length > 0);
            ...
            const lastBlock = trackData.blocks[(0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .last */ ._g)(trackData.presentationTimestamps).blockIndex];
            ...
            const insertionIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .binarySearchLessOrEqual */ .eE)(track.clusterPositionCache, trackData.startTimestamp, x => x.startTimestamp);
            if (insertionIndex === -1
    ...
    expandLacedBlocks(blocks, track) {
        ...
        for (let blockIndex = 0; blockIndex < blocks.length; blockIndex++) {
            ...
            const slice = _reader_js__WEBPACK_IMPORTED_MODULE_9__/* .FileSlice */ .x$.tempFromBytes(originalBlock.data);
            const frameSizes = [];
            const frameCount = (0,_reader_js__WEBPACK_IMPORTED_MODULE_9__/* .readU8 */ .eo)(slice) + 1;
                ...
                case BlockLacing.Xiph:
                    {
                        ...
                        for (let i = 0; i < frameCount - 1; i++) {
                            ...
                            while (slice.bufferPos < slice.length) {
                                const value = (0,_reader_js__WEBPACK_IMPORTED_MODULE_9__/* .readU8 */ .eo)(slice);
                                frameSize += value;
                                if (value < 255) {
                ...
                case BlockLacing.Ebml:
                    {
                        ...
                        const firstResult = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readVarInt */ .pT)(slice);
                        (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(firstResult !== null); // Assume it's not an invalid VINT
                        let currentSize = firstResult;
                        frameSizes.push(currentSize);
                        let totalUsedSize = currentSize;
                        for (let i = 1; i < frameCount - 1; i++) {
                            const startPos = slice.bufferPos;
                            const diffResult = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readVarInt */ .pT)(slice);
                            (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(diffResult !== null);
                    ...
                    ;
                    break;
                default: (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(false);
            }
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(frameSizes.length === frameCount);
            blocks.splice(blockIndex, 1); // Remove the original block
            const blockDuration = originalBlock.duration || frameCount * (track.defaultDuration ?? 0);
            // Now, let's insert each frame as its own block
            for (let i = 0; i < frameCount; i++) {
                const frameSize = frameSizes[i];
                const frameData = (0,_reader_js__WEBPACK_IMPORTED_MODULE_9__/* .readBytes */ .io)(slice, frameSize);
    ...
    async loadSegmentMetadata(segment) {
        for (const seekEntry of segment.seekEntries) {
            if (seekEntry.id === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Tags && !segment.tagsSeen) {
                // We need to load the tags
            }
            else if (seekEntry.id === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Attachments && !segment.attachmentsSeen) {
                // We need to load the attachments
            }
            else {
                continue;
            }
            let slice = this.reader.requestSliceRange(segment.dataStartPos + seekEntry.segmentPosition, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_HEADER_SIZE */ .De, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MAX_HEADER_SIZE */ .r1);
            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .isThenable */ .Qg)(slice))
                slice = await slice;
            if (!slice)
                continue;
            ...
            const { size } = header;
            (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .assertDefinedSize */ .p)(size);
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(!this.currentSegment);
            ...
            this.currentSegment = null;
            // Mark as seen
            if (seekEntry.id === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Tags) {
                segment.tagsSeen = true;
            }
            else if (seekEntry.id === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Attachments) {
                segment.attachmentsSeen = true;
            }
        }
    }
    readContiguousElements(slice, stopIds) {
        while (slice.remainingLength >= _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_HEADER_SIZE */ .De) {
            const startPos = slice.filePos;
    ...
    traverseElement(slice, stopIds) {
        ...
        (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .assertDefinedSize */ .p)(size);
        switch (id) {
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.DocType:
                {
                    this.isWebM = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readAsciiString */ .IX)(slice, size) === 'webm';
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Seek:
                {
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.SeekID:
                {
                    const lastSeekEntry = this.currentSegment?.seekEntries[this.currentSegment.seekEntries.length - 1];
                    if (!lastSeekEntry)
                        break;
                    lastSeekEntry.id = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.SeekPosition:
                {
                    const lastSeekEntry = this.currentSegment?.seekEntries[this.currentSegment.seekEntries.length - 1];
                    if (!lastSeekEntry)
                        break;
                    lastSeekEntry.segmentPosition = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TimestampScale:
                {
                    if (!this.currentSegment)
                        break;
                    this.currentSegment.timestampScale = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                    this.currentSegment.timestampFactor = 1e9 / this.currentSegment.timestampScale;
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Duration:
                {
                    if (!this.currentSegment)
                        break;
                    this.currentSegment.duration = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readFloat */ .zH)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TrackEntry:
                {
                    if (!this.currentSegment)
                        break;
                    this.currentTrack = {
                        ...
                        cuePoints: [],
                        disposition: {
                            ..._metadata_js__WEBPACK_IMPORTED_MODULE_4__/* .DEFAULT_TRACK_DISPOSITION */ .gM,
                            primary: false,
                        },
                        trackBacking: null,
                        codecId: null,
                    ...
                    if (this.currentTrack.decodingInstructions.some((instruction) => {
                        ...
                        _logging_js__WEBPACK_IMPORTED_MODULE_3__/* .Logging */ .y._warn(`Track #${this.currentTrack.id} has an unsupported content encoding; dropping.`);
                        this.currentTrack = null;
                    }
                    if (this.currentTrack
                        ...
                        if (this.currentTrack.info.type === 'video'
                            ...
                            if (this.currentTrack.codecId === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.avc) {
                                this.currentTrack.info.codec = 'avc';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (this.currentTrack.codecId === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.hevc) {
                                this.currentTrack.info.codec = 'hevc';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.vp8) {
                                this.currentTrack.info.codec = 'vp8';
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.vp9) {
                                this.currentTrack.info.codec = 'vp9';
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.av1) {
                                this.currentTrack.info.codec = 'av1';
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.prores) {
                                const format = this.currentTrack.codecPrivate
                                    ? _misc_js__WEBPACK_IMPORTED_MODULE_5__/* .textDecoder */ .su.decode(this.currentTrack.codecPrivate)
                                    : '';
                                if (_codec_js__WEBPACK_IMPORTED_MODULE_1__/* .PRORES_FOURCCS */ .Y2.includes(format)) {
                            ...
                            if (codecIdWithoutSuffix === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.aac) {
                            ...
                            else if (this.currentTrack.codecId === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.mp3) {
                                this.currentTrack.info.codec = 'mp3';
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.opus) {
                                this.currentTrack.info.codec = 'opus';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                                this.currentTrack.info.sampleRate = _codec_js__WEBPACK_IMPORTED_MODULE_1__/* .OPUS_SAMPLE_RATE */ .yo; // Always the same
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.vorbis) {
                                this.currentTrack.info.codec = 'vorbis';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.flac) {
                                this.currentTrack.info.codec = 'flac';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.ac3) {
                                this.currentTrack.info.codec = 'ac3';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.eac3) {
                                this.currentTrack.info.codec = 'eac3';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .CODEC_STRING_MAP */ .oo.dts) {
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TrackNumber:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.id = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TrackType:
                {
                    if (!this.currentTrack)
                        break;
                    const type = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                    if (type === 1) {
                        this.currentTrack.info = {
                            type: 'video',
                            width: -1,
                            ...
                            codec: null,
                            codecDescription: null,
                            colorSpace: { ..._misc_js__WEBPACK_IMPORTED_MODULE_5__/* .EMPTY_COLOR_SPACE */ .jW },
                            alphaMode: false,
                            proresFormat: null,
                        };
                    }
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.FlagEnabled:
                {
                    if (!this.currentTrack)
                        break;
                    const enabled = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                    if (!enabled) {
                        this.currentTrack = null;
                    }
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.FlagDefault:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.disposition.default = !!(0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.FlagForced:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.disposition.forced = !!(0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.FlagOriginal:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.disposition.original = !!(0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.FlagHearingImpaired:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.disposition.hearingImpaired = !!(0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.FlagVisualImpaired:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.disposition.visuallyImpaired = !!(0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.FlagCommentary:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.disposition.commentary = !!(0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.CodecID:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.codecId = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readAsciiString */ .IX)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.CodecPrivate:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.codecPrivate = (0,_reader_js__WEBPACK_IMPORTED_MODULE_9__/* .readBytes */ .io)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.DefaultDuration:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.defaultDurationNs = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Name:
                {
                    if (!this.currentTrack)
                        break;
                    this.currentTrack.name = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnicodeString */ .jR)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Language:
                {
                    if (!this.currentTrack)
                        break;
                    ...
                    this.currentTrack.languageCode = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readAsciiString */ .IX)(slice, size);
                    if (!(0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .isIso639Dash2LanguageCode */ .Nu)(this.currentTrack.languageCode)) {
                        this.currentTrack.languageCode = _misc_js__WEBPACK_IMPORTED_MODULE_5__/* .UNDETERMINED_LANGUAGE */ .IR;
                    }
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.LanguageBCP47:
                {
                    if (!this.currentTrack)
                        break;
                    const bcp47 = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readAsciiString */ .IX)(slice, size);
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Video:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.PixelWidth:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.currentTrack.info.width = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.PixelHeight:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.currentTrack.info.height = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.DisplayWidth:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.currentTrack.info.displayWidth = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.DisplayHeight:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.currentTrack.info.displayHeight = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.DisplayUnit:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.currentTrack.info.displayUnit = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.AlphaMode:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.currentTrack.info.alphaMode = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size) === 1;
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Colour:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.MatrixCoefficients:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    const matrixCoefficients = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                    const mapped = _misc_js__WEBPACK_IMPORTED_MODULE_5__/* .MATRIX_COEFFICIENTS_MAP_INVERSE */ .fl[matrixCoefficients];
                    this.currentTrack.info.colorSpace.matrix = mapped;
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Range:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    const range = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TransferCharacteristics:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    const transferCharacteristics = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                    const mapped = _misc_js__WEBPACK_IMPORTED_MODULE_5__/* .TRANSFER_CHARACTERISTICS_MAP_INVERSE */ .x_[transferCharacteristics];
                    this.currentTrack.info.colorSpace.transfer = mapped;
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Primaries:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    const primaries = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                    const mapped = _misc_js__WEBPACK_IMPORTED_MODULE_5__/* .COLOR_PRIMARIES_MAP_INVERSE */ .BL[primaries];
                    this.currentTrack.info.colorSpace.primaries = mapped;
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Projection:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.ProjectionPoseRoll:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    const rotation = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readFloat */ .zH)(slice, size);
                    const flippedRotation = -rotation; // Convert counter-clockwise to clockwise
                    try {
                        this.currentTrack.info.rotation = (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .normalizeRotation */ .qT)(flippedRotation);
                    }
                    catch {
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Audio:
                {
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.SamplingFrequency:
                {
                    if (this.currentTrack?.info?.type !== 'audio')
                        break;
                    this.currentTrack.info.sampleRate = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readFloat */ .zH)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Channels:
                {
                    if (this.currentTrack?.info?.type !== 'audio')
                        break;
                    this.currentTrack.info.numberOfChannels = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.BitDepth:
                {
                    if (this.currentTrack?.info?.type !== 'audio')
                        break;
                    this.currentTrack.info.bitDepth = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.CuePoint:
                {
                    if (!this.currentSegment)
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.CueTime:
                {
                    this.currentCueTime = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.CueTrackPositions:
                {
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.CueTrack:
                {
                    const lastCuePoint = this.currentSegment?.cuePoints[this.currentSegment.cuePoints.length - 1];
                    if (!lastCuePoint)
                        break;
                    lastCuePoint.trackId = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.CueClusterPosition:
                {
                    const lastCuePoint = this.currentSegment?.cuePoints[this.currentSegment.cuePoints.length - 1];
                    if (!lastCuePoint)
                        break;
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(this.currentSegment);
                    lastCuePoint.clusterPosition = this.currentSegment.dataStartPos + (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Timestamp:
                {
                    if (!this.currentCluster)
                        break;
                    this.currentCluster.timestamp = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.SimpleBlock:
                {
                    if (!this.currentCluster)
                        break;
                    const trackNumber = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readVarInt */ .pT)(slice);
                    if (trackNumber === null)
                        break;
                    const trackData = this.getTrackDataInCluster(this.currentCluster, trackNumber);
                    if (!trackData)
                        break; // Not a track we care about
                    const relativeTimestamp = (0,_reader_js__WEBPACK_IMPORTED_MODULE_9__/* .readI16Be */ .iH)(slice);
                    const flags = (0,_reader_js__WEBPACK_IMPORTED_MODULE_9__/* .readU8 */ .eo)(slice);
                    ...
                    const blockData = (0,_reader_js__WEBPACK_IMPORTED_MODULE_9__/* .readBytes */ .io)(slice, size - (slice.filePos - dataStartPos));
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.BlockGroup:
                {
                    if (!this.currentCluster)
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Block:
                {
                    if (!this.currentCluster)
                        break;
                    const trackNumber = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readVarInt */ .pT)(slice);
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.BlockAdditions:
                {
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.BlockMore:
                {
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.BlockAdditional:
                {
                    if (!this.currentBlockAdditional)
                        break;
                    this.currentBlockAdditional.data = (0,_reader_js__WEBPACK_IMPORTED_MODULE_9__/* .readBytes */ .io)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.BlockAddID:
                {
                    if (!this.currentBlockAdditional)
                        break;
                    this.currentBlockAdditional.addId = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.BlockDuration:
                {
                    if (!this.currentBlock)
                        break;
                    this.currentBlock.duration = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.ReferenceBlock:
                {
                    if (!this.currentBlock)
                        break;
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Tag:
                {
                    this.currentTagTargetIsMovie = true;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Targets:
                {
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TargetTypeValue:
                {
                    const targetTypeValue = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TagTrackUID:
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TagEditionUID:
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TagChapterUID:
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TagAttachmentUID:
                {
                    this.currentTagTargetIsMovie = false;
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.SimpleTag:
                {
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TagName:
                {
                    this.currentSimpleTagName = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnicodeString */ .jR)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TagString:
                {
                    if (!this.currentSimpleTagName)
                        break;
                    const value = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnicodeString */ .jR)(slice, size);
                    this.processTagValue(this.currentSimpleTagName, value);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.TagBinary:
                {
                    if (!this.currentSimpleTagName)
                        break;
                    const value = (0,_reader_js__WEBPACK_IMPORTED_MODULE_9__/* .readBytes */ .io)(slice, size);
                    this.processTagValue(this.currentSimpleTagName, value);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.AttachedFile:
                {
                    if (!this.currentSegment)
                        break;
                    ...
                    if (this.currentAttachedFile.fileUid && this.currentAttachedFile.fileData) {
                        ...
                        tags.raw ??= {};
                        tags.raw[this.currentAttachedFile.fileUid.toString()] = new _metadata_js__WEBPACK_IMPORTED_MODULE_4__/* .AttachedFile */ .VF(this.currentAttachedFile.fileData, this.currentAttachedFile.fileMediaType ?? undefined, this.currentAttachedFile.fileName ?? undefined, this.currentAttachedFile.fileDescription ?? undefined);
                    }
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.FileUID:
                {
                    if (!this.currentAttachedFile)
                        break;
                    this.currentAttachedFile.fileUid = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedBigInt */ .Ry)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.FileName:
                {
                    if (!this.currentAttachedFile)
                        break;
                    this.currentAttachedFile.fileName = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnicodeString */ .jR)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.FileMediaType:
                {
                    if (!this.currentAttachedFile)
                        break;
                    this.currentAttachedFile.fileMediaType = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readAsciiString */ .IX)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.FileData:
                {
                    if (!this.currentAttachedFile)
                        break;
                    this.currentAttachedFile.fileData = (0,_reader_js__WEBPACK_IMPORTED_MODULE_9__/* .readBytes */ .io)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.FileDescription:
                {
                    if (!this.currentAttachedFile)
                        break;
                    this.currentAttachedFile.fileDescription = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnicodeString */ .jR)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.ContentEncodings:
                {
                    if (!this.currentTrack)
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.ContentEncoding:
                {
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.ContentEncodingOrder:
                {
                    if (!this.currentDecodingInstruction)
                        break;
                    this.currentDecodingInstruction.order = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.ContentEncodingScope:
                {
                    if (!this.currentDecodingInstruction)
                        break;
                    this.currentDecodingInstruction.scope = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.ContentCompression:
                {
                    if (!this.currentDecodingInstruction)
                        break;
                ...
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.ContentCompAlgo:
                {
                    if (this.currentDecodingInstruction?.data?.type !== 'decompress')
                        break;
                    this.currentDecodingInstruction.data.algorithm = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readUnsignedInt */ .dl)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.ContentCompSettings:
                {
                    if (this.currentDecodingInstruction?.data?.type !== 'decompress')
                        break;
                    this.currentDecodingInstruction.data.settings = (0,_reader_js__WEBPACK_IMPORTED_MODULE_9__/* .readBytes */ .io)(slice, size);
                }
                ;
                break;
            case _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.ContentEncryption:
                {
                    if (!this.currentDecodingInstruction)
                        break;
                    this.currentDecodingInstruction.data = {
    ...
    decodeBlockData(track, rawData) {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(track.decodingInstructions.length > 0); // This method shouldn't be called otherwise
        let currentData = rawData;
        for (const instruction of track.decodingInstructions) {
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(instruction.data);
...
class MatroskaTrackBacking {
    ...
    intoTimescale(timestamp) {
        ...
        // that the number was originally an integer divided by the timescale. For stability, it's best
        // to return the integer in this case.
        return (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .roundIfAlmostInteger */ .aI)(timestamp * this.internalTrack.segment.timestampFactor);
    }
    async getPacket(timestamp, options) {
        ...
        return this.performClusterLookup(null, (cluster) => {
            ...
            const index = (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .binarySearchLessOrEqual */ .eE)(trackData.presentationTimestamps, timestampInTimescale, x => x.timestamp);
    ...
    async getKeyPacket(timestamp, options) {
        ...
        return this.performClusterLookup(null, (cluster) => {
            ...
            const index = (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .findLastIndex */ .Kl)(trackData.presentationTimestamps, (x) => {
        ...
        return this.performClusterLookup(locationInCluster.cluster, (cluster) => {
            if (cluster === locationInCluster.cluster) {
                ...
                if (trackData && trackData.firstKeyFrameTimestamp !== null) {
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(keyFrameIndex !== -1); // There must be one
                    return {
    ...
    async fetchPacketInCluster(cluster, blockIndex, options) {
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(block);
        ...
        if (!block.postProcessed) {
            if (this.internalTrack.info?.codec === 'prores') {
                ...
                if (!hasFrameContainer) {
                    ...
                    const newDataView = (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .toDataView */ .Zc)(newData);
        ...
        const data = options.metadataOnly ? _packet_js__WEBPACK_IMPORTED_MODULE_6__/* .PLACEHOLDER_DATA */ .T : block.data;
        const timestamp = block.timestamp / this.internalTrack.segment.timestampFactor;
        const duration = block.duration / this.internalTrack.segment.timestampFactor;
        const sideData = {};
        if (block.mainAdditional && this.internalTrack.info?.type === 'video' && this.internalTrack.info.alphaMode) {
            sideData.alpha = options.metadataOnly ? _packet_js__WEBPACK_IMPORTED_MODULE_6__/* .PLACEHOLDER_DATA */ .T : block.mainAdditional;
            sideData.alphaByteLength = block.mainAdditional.byteLength;
        }
        const packet = new _packet_js__WEBPACK_IMPORTED_MODULE_6__/* .EncodedPacket */ .Z(data, block.isKeyFrame ? 'key' : 'delta', timestamp, duration, cluster.dataStartPos + blockIndex, block.data.byteLength, sideData);
    ...
    latestTimestamp, options) {
        ...
        const cuePointIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .binarySearchLessOrEqual */ .eE)(this.internalTrack.cuePoints, searchTimestamp, x => x.time);
        const cuePoint = cuePointIndex !== -1
            ? this.internalTrack.cuePoints[cuePointIndex]
            : null;
        // Also check the position cache
        const positionCacheIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .binarySearchLessOrEqual */ .eE)(this.internalTrack.clusterPositionCache, searchTimestamp, x => x.startTimestamp);
        const positionCacheEntry = positionCacheIndex !== -1
        ...
        while (segment.elementEndPos === null || currentPos <= segment.elementEndPos - _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_HEADER_SIZE */ .De) {
            if (currentCluster) {
            ...
            // Load the header
            let slice = demuxer.reader.requestSliceRange(currentPos, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_HEADER_SIZE */ .De, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MAX_HEADER_SIZE */ .r1);
            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .isThenable */ .Qg)(slice))
                slice = await slice;
            if (!slice)
                break;
            const elementStartPos = currentPos;
            const elementHeader = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readElementHeader */ .ur)(slice);
            if (!elementHeader
                || (!_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .LEVEL_1_EBML_IDS */ .VE.includes(elementHeader.id) && elementHeader.id !== _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Void)) {
                ...
                const nextPos = await (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .resync */ .nE)(demuxer.reader, elementStartPos, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .LEVEL_1_EBML_IDS */ .VE, Math.min(segment.elementEndPos ?? Infinity, elementStartPos + MAX_RESYNC_LENGTH));
                if (nextPos) {
                    currentPos = nextPos;
                    continue;
                }
            ...
            let size = elementHeader.size;
            const dataStartPos = slice.filePos;
            if (id === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Cluster) {
            ...
            if (size === undefined) {
                ...
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(id !== _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Cluster); // Undefined cluster sizes are fixed further up
                // Search for the next element at level 0 or 1
                const nextElementPos = await (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .searchForNextElementId */ .IQ)(demuxer.reader, dataStartPos, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .LEVEL_0_AND_1_EBML_IDS */ .K9, segment.elementEndPos);
                size = nextElementPos.pos - dataStartPos;
            }
            ...
            if (segment.elementEndPos === null) {
                ...
                // the first segment.
                let slice = demuxer.reader.requestSliceRange(endPos, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MIN_HEADER_SIZE */ .De, _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .MAX_HEADER_SIZE */ .r1);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .isThenable */ .Qg)(slice))
                    slice = await slice;
                if (!slice)
                    break;
                const elementId = (0,_ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .readElementId */ .SR)(slice);
                if (elementId === _ebml_js__WEBPACK_IMPORTED_MODULE_7__/* .EBMLId */ .Cl.Segment) {
        ...
        if (cuePoint && (!bestCluster || bestCluster.elementStartPos < cuePoint.clusterPosition)) {
            ...
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .assert */ .vA)(!previousCuePoint || previousCuePoint.time < cuePoint.time);
        ...
        return this.decoderConfigPromise ??= (async () => {
            ...
            const codecInfo = {
                ...
                avcCodecInfo: this.internalTrack.info.codec === 'avc' && firstPacket
                    ? (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_0__/* .extractAvcDecoderConfigurationRecord */ .fH)(firstPacket.data)
                    : null,
                hevcCodecInfo: this.internalTrack.info.codec === 'hevc' && firstPacket
                    ? (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_0__/* .extractHevcDecoderConfigurationRecord */ .D5)(firstPacket.data)
                    : null,
                vp9CodecInfo: this.internalTrack.info.codec === 'vp9' && firstPacket
                    ? (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_0__/* .extractVp9CodecInfoFromPacket */ .bs)(firstPacket.data)
                    : null,
                av1CodecInfo: this.internalTrack.info.codec === 'av1' && firstPacket
                    ? (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_0__/* .extractAv1CodecInfoFromPacket */ .UU)(firstPacket.data)
                    : null,
                proresCodecInfo: this.internalTrack.info.codec === 'prores' && firstPacket
                    ? (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_0__/* .extractProresCodecInfoFromPacket */ .RU)(firstPacket.data)
                    : null,
                proresFormat: this.internalTrack.info.proresFormat,
            };
            if (!(0,_misc_js__WEBPACK_IMPORTED_MODULE_5__/* .colorSpaceIsComplete */ .HV)(this.internalTrack.info.colorSpace)) {
                const colorSpace = (0,_codec_js__WEBPACK_IMPORTED_MODULE_1__/* .extractColorSpace */ .LD)(codecInfo);
                // Fill the missing values
                this.internalTrack.info.colorSpace.primaries ??= colorSpace.primaries;
                this.internalTrack.info.colorSpace.transfer ??= colorSpace.transfer;
                this.internalTrack.info.colorSpace.matrix ??= colorSpace.matrix;
            ...
            const config = {
                codec: (0,_codec_js__WEBPACK_IMPORTED_MODULE_1__/* .extractVideoCodecString */ .QP)(codecInfo),
                codedWidth: this.internalTrack.info.width,
                codedHeight: this.internalTrack.info.height,
                description: this.internalTrack.info.codecDescription ?? undefined,
                colorSpace: this.internalTrack.info.colorSpace,
    ...
    async getDecoderConfig() {
        ...
        return this.decoderConfigPromise ??= (async () => {
            if (this.internalTrack.info.codec === 'dts' && !this.internalTrack.info.dtsFormat) {
                // Gotta check the packet to determine the DTS variant
                const firstPacket = await this.getFirstPacket({});
                this.internalTrack.info.dtsFormat = firstPacket && (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_0__/* .extractDtsFourCcFromPacket */ .n$)(firstPacket.data);
            }
            return {
                codec: (0,_codec_js__WEBPACK_IMPORTED_MODULE_1__/* .extractAudioCodecString */ .X0)({
                    codec: this.internalTrack.info.codec,
                    codecDescription: this.internalTrack.info.codecDescription,
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   l: () => (/* binding */ Mp3Demuxer)
/* harmony export */ });
...
/* harmony import */ var _misc_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3912);
/* harmony import */ var _packet_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3936);
/* harmony import */ var _shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2788);
/* harmony import */ var _id3_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7576);
/* harmony import */ var _mp3_reader_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6757);
/* harmony import */ var _reader_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(7735);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class Mp3Demuxer extends _demuxer_js__WEBPACK_IMPORTED_MODULE_0__/* .Demuxer */ .B {
    constructor(input) {
        super(input);
        this.metadataPromise = null;
        this.firstFrameHeader = null;
    ...
    async advanceReader() {
        if (this.lastLoadedPos === 0) {
            ...
            while (true) {
                let slice = this.reader.requestSlice(this.lastLoadedPos, _id3_js__WEBPACK_IMPORTED_MODULE_5__/* .ID3_V2_HEADER_SIZE */ .sY);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .isThenable */ .Qg)(slice))
                    slice = await slice;
                if (!slice) {
                    this.lastSampleLoaded = true;
        ...
        const result = await (0,_mp3_reader_js__WEBPACK_IMPORTED_MODULE_6__/* .readNextMp3FrameHeader */ .W)(this.reader, this.lastLoadedPos, this.reader.fileSize, this.firstFrameHeader);
        if (!result) {
            this.lastSampleLoaded = true;
            return;
        }
        ...
        const xingOffset = (0,_shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .getXingOffset */ .EZ)(header.mpegVersionId, header.channel);
        let slice = this.reader.requestSlice(result.startPos + xingOffset, 4);
        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .isThenable */ .Qg)(slice))
            slice = await slice;
        if (slice) {
            const word = (0,_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readU32Be */ .cN)(slice);
            const isXing = word === _shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .XING */ .hY || word === _shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .INFO */ .rD;
            if (isXing) {
                ...
                if (!this.xingData) {
                    ...
                    if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .isThenable */ .Qg)(xingDataSlice))
                        xingDataSlice = await xingDataSlice;
                    if (xingDataSlice) {
                        const xingData = (0,_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readBytes */ .io)(xingDataSlice, 12);
                        const view = (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .toDataView */ .Zc)(xingData);
                        const flags = view.getUint32(0, false);
                        this.xingData = {
                            frameCount: (flags & _shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .XingFlags */ .MJ.FrameCount)
                                ? view.getUint32(4, false)
                                : null,
                            fileSize: (flags & _shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .XingFlags */ .MJ.FileSize)
    ...
    async getMetadataTags() {
        ...
        try {
            ...
            while (true) {
                let headerSlice = this.reader.requestSlice(currentPos, _id3_js__WEBPACK_IMPORTED_MODULE_5__/* .ID3_V2_HEADER_SIZE */ .sY);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .isThenable */ .Qg)(headerSlice))
                    headerSlice = await headerSlice;
                if (!headerSlice)
                    break;
                const id3V2Header = (0,_id3_js__WEBPACK_IMPORTED_MODULE_5__/* .readId3V2Header */ .IX)(headerSlice);
                if (!id3V2Header) {
                    break;
                }
            ...
            if (!id3V2HeaderFound && this.reader.fileSize !== null && this.reader.fileSize >= _id3_js__WEBPACK_IMPORTED_MODULE_5__/* .ID3_V1_TAG_SIZE */ .aU) {
                // Try reading an ID3v1 tag at the end of the file
                let slice = this.reader.requestSlice(this.reader.fileSize - _id3_js__WEBPACK_IMPORTED_MODULE_5__/* .ID3_V1_TAG_SIZE */ .aU, _id3_js__WEBPACK_IMPORTED_MODULE_5__/* .ID3_V1_TAG_SIZE */ .aU);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .isThenable */ .Qg)(slice))
                    slice = await slice;
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(slice);
                const tag = (0,_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readAscii */ .IT)(slice, 3);
                if (tag === 'TAG') {
                    (0,_id3_js__WEBPACK_IMPORTED_MODULE_5__/* .parseId3V1Tag */ .p_)(slice, this.metadataTags);
                }
            }
            return this.metadataTags;
        }
...
class Mp3AudioTrackBacking {
    ...
    getTimeResolution() {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(this.demuxer.firstFrameHeader);
    ...
    async getDurationFromMetadata() {
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(demuxer.firstFrameHeader !== null);
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(demuxer.firstFrameHeaderPos !== null);
        if (demuxer.xingData) {
            ...
            if (demuxer.reader.fileSize !== null) {
                const averageFrameSize = (0,_shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .computeAverageMp3FrameSize */ .hD)(demuxer.firstFrameHeader.lowSamplingFrequency, demuxer.firstFrameHeader.layer, demuxer.firstFrameHeader.bitrate, demuxer.firstFrameHeader.sampleRate);
    ...
    getNumberOfChannels() {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(this.demuxer.firstFrameHeader);
        return (0,_shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .getMp3ChannelCount */ .fX)(this.demuxer.firstFrameHeader.channel);
    }
    getSampleRate() {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .assert */ .vA)(this.demuxer.firstFrameHeader);
    ...
    async getDecoderConfig() {
        ...
        return {
            codec: 'mp3',
            numberOfChannels: (0,_shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .getMp3ChannelCount */ .fX)(this.demuxer.firstFrameHeader.channel),
    ...
    async getPacketAtIndex(sampleIndex, options) {
        ...
        if (options.metadataOnly) {
            ...
            data = (0,_reader_js__WEBPACK_IMPORTED_MODULE_7__/* .readBytes */ .io)(slice, rawSample.dataSize);
        }
        return new _packet_js__WEBPACK_IMPORTED_MODULE_3__/* .EncodedPacket */ .Z(data, 'key', rawSample.timestamp, rawSample.duration, sampleIndex, rawSample.dataSize);
    }
    getFirstPacket(options) {
        return this.getPacketAtIndex(0, options);
    }
    async getNextPacket(packet, options) {
        const release = await this.demuxer.readingMutex.acquire();
        try {
            const sampleIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .binarySearchExact */ .pl)(this.demuxer.loadedSamples, packet.timestamp, x => x.timestamp);
            if (sampleIndex === -1) {
                throw new Error('Packet was not created from this track.');
            }
            const nextIndex = sampleIndex + 1;
    ...
    async getPacket(timestamp, options) {
        ...
        try {
            while (true) {
                const index = (0,_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .binarySearchLessOrEqual */ .eE)(this.demuxer.loadedSamples, timestamp, x => x.timestamp);
                if (index === -1 && this.demuxer.loadedSamples.length > 0) {
                    // We're before the first sample
                    return null;
                }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   W: () => (/* binding */ readNextMp3FrameHeader)
/* harmony export */ });
...
const readNextMp3FrameHeader = async (reader, startPos, until, ref = null) => {
    ...
    while (until === null || currentPos < until) {
        const maxLength = until !== null
            ...
            : CHUNK_SIZE;
        let slice = reader.requestSliceRange(currentPos, _shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .MP3_FRAME_HEADER_SIZE */ .D_, maxLength);
        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_1__/* .isThenable */ .Qg)(slice))
            slice = await slice;
        if (!slice || slice.length < _shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .MP3_FRAME_HEADER_SIZE */ .D_)
            break;
        while (slice.remainingLength >= _shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .MP3_FRAME_HEADER_SIZE */ .D_) {
            const posBeforeRead = slice.filePos;
            const word = (0,_reader_js__WEBPACK_IMPORTED_MODULE_2__/* .readU32Be */ .cN)(slice);
            const remainingBytes = reader.fileSize !== null
                ? reader.fileSize - currentPos
                : null;
            const result = (0,_shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .readMp3FrameHeader */ .P8)(word, remainingBytes);
            if (result.header
                && (!ref || (
                ...
                result.header.sampleRate === ref.sampleRate
                    ...
                    && (0,_shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .getMp3ChannelCount */ .fX)(result.header.channel) === (0,_shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_0__/* .getMp3ChannelCount */ .fX)(ref.channel)))) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   f: () => (/* binding */ MpegTsDemuxer)
/* harmony export */ });
/* harmony import */ var _adts_adts_demuxer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9086);
/* harmony import */ var _adts_adts_reader_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8475);
/* harmony import */ var _shared_aac_misc_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1299);
/* harmony import */ var _codec_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1188);
/* harmony import */ var _codec_data_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6297);
/* harmony import */ var _demuxer_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7202);
/* harmony import */ var _logging_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6103);
/* harmony import */ var _metadata_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5165);
/* harmony import */ var _misc_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(3912);
/* harmony import */ var _shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(2788);
/* harmony import */ var _packet_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(3936);
/* harmony import */ var _reader_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(7735);
/* harmony import */ var _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(2490);
/* harmony import */ var _shared_ac3_misc_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(7553);
/* harmony import */ var _shared_bitstream_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(1390);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class MpegTsDemuxer extends _demuxer_js__WEBPACK_IMPORTED_MODULE_5__/* .Demuxer */ .B {
    constructor(input) {
        super(input);
        this.metadataPromise = null;
    ...
    async readMetadata() {
        return this.metadataPromise ??= (async () => {
            const lengthToCheck = _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TS_PACKET_SIZE */ .ZT + 16 + 1;
            let startingSlice = this.reader.requestSlice(0, lengthToCheck);
            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .isThenable */ .Qg)(startingSlice))
                startingSlice = await startingSlice;
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(startingSlice);
            const startingBytes = (0,_reader_js__WEBPACK_IMPORTED_MODULE_11__/* .readBytes */ .io)(startingSlice, lengthToCheck);
            if (startingBytes[0] === 0x47 && startingBytes[_mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TS_PACKET_SIZE */ .ZT] === 0x47) {
                // Regular MPEG-TS
                this.packetOffset = 0;
                this.packetStride = _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TS_PACKET_SIZE */ .ZT;
            }
            else if (startingBytes[0] === 0x47 && startingBytes[_mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TS_PACKET_SIZE */ .ZT + 16] === 0x47) {
                // MPEG-TS with Forward Error Correction
                this.packetOffset = 0;
                this.packetStride = _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TS_PACKET_SIZE */ .ZT + 16;
            }
            else if (startingBytes[4] === 0x47 && startingBytes[4 + _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TS_PACKET_SIZE */ .ZT + 4] === 0x47) {
                // MPEG-2-TS (DVHS)
                this.packetOffset = 4;
                this.packetStride = _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TS_PACKET_SIZE */ .ZT + 4;
            }
            else {
            ...
            while (true) {
                ...
                if (!hasProgramMap && section.pid !== 0) {
                    ...
                    if (!isPesPacket) {
                        // Assume it's a PSI
                        const bitstream = new _shared_bitstream_js__WEBPACK_IMPORTED_MODULE_14__/* .Bitstream */ ._(section.payload);
                        ...
                        switch (effectiveStreamType) {
                            ...
                            default: {
                                ...
                                if (!ignoredStreamTypes.has(streamType)) {
                                    _logging_js__WEBPACK_IMPORTED_MODULE_6__/* .Logging */ .y._warn(`Note: MPEG-TS streams with stream_type 0x${streamType.toString(16)} are not`
                                        + ` currently supported.`);
                    ...
                    outer: if (elementaryStream && !elementaryStream.initialized) {
                        ...
                        if (elementaryStream.info.type === 'video') {
                            ...
                            while (true) {
                                ...
                                if (elementaryStream.info.codec === 'avc') {
                                    ...
                                    elementaryStream.info.avcCodecInfo
                                        = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .extractAvcDecoderConfigurationRecord */ .fH)(context.suppliedPacket.data);
                                    ...
                                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(spsUnit);
                                    const spsInfo = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .parseAvcSps */ .eM)(spsUnit);
                                    ...
                                    elementaryStream.info.colorSpace = {
                                        primaries: _misc_js__WEBPACK_IMPORTED_MODULE_8__/* .COLOR_PRIMARIES_MAP_INVERSE */ .BL[spsInfo.colourPrimaries],
                                        transfer: _misc_js__WEBPACK_IMPORTED_MODULE_8__/* .TRANSFER_CHARACTERISTICS_MAP_INVERSE */ .x_[spsInfo.transferCharacteristics],
                                        matrix: _misc_js__WEBPACK_IMPORTED_MODULE_8__/* .MATRIX_COEFFICIENTS_MAP_INVERSE */ .fl[spsInfo.matrixCoefficients],
                                    ...
                                    elementaryStream.info.hevcCodecInfo
                                        = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .extractHevcDecoderConfigurationRecord */ .D5)(context.suppliedPacket.data);
                                    if (!elementaryStream.info.hevcCodecInfo) {
                                        continue; // Search the next packet for it
                                    }
                                    const spsArray = elementaryStream.info.hevcCodecInfo.arrays.find(a => a.nalUnitType === _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .HevcNalUnitType */ .iJ.SPS_NUT);
                                    const spsUnit = spsArray.nalUnits[0];
                                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(spsUnit);
                                    const spsInfo = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .parseHevcSps */ .gT)(spsUnit);
                                    elementaryStream.info.width = spsInfo.displayWidth;
                                    elementaryStream.info.height = spsInfo.displayHeight;
                            ...
                            elementaryStream.info.decoderConfig = {
                                codec: (0,_codec_js__WEBPACK_IMPORTED_MODULE_3__/* .extractVideoCodecString */ .QP)({
                            ...
                            if (elementaryStream.info.codec === 'aac') {
                                const slice = _reader_js__WEBPACK_IMPORTED_MODULE_11__/* .FileSlice */ .x$.tempFromBytes(context.suppliedPacket.data);
                                const header = (0,_adts_adts_reader_js__WEBPACK_IMPORTED_MODULE_1__/* .readAdtsFrameHeader */ .lh)(slice);
                                if (!header) {
                                ...
                                elementaryStream.info.numberOfChannels
                                    = _shared_aac_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .aacChannelMap */ .Ti[header.channelConfiguration];
                                elementaryStream.info.sampleRate
                                    = _shared_aac_misc_js__WEBPACK_IMPORTED_MODULE_2__/* .aacFrequencyTable */ .Im[header.samplingFrequencyIndex];
                            }
                            else if (elementaryStream.info.codec === 'mp3') {
                                const word = (0,_reader_js__WEBPACK_IMPORTED_MODULE_11__/* .readU32Be */ .cN)(_reader_js__WEBPACK_IMPORTED_MODULE_11__/* .FileSlice */ .x$.tempFromBytes(context.suppliedPacket.data));
                                const result = (0,_shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_9__/* .readMp3FrameHeader */ .P8)(word, context.suppliedPacket.data.byteLength);
                                if (!result.header) {
                                    throw new Error('Invalid MP3 audio stream; could not read frame header from first packet.');
                                }
                                elementaryStream.info.numberOfChannels = (0,_shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_9__/* .getMp3ChannelCount */ .fX)(result.header.channel);
                                elementaryStream.info.sampleRate = result.header.sampleRate;
                            }
                            else if (elementaryStream.info.codec === 'ac3') {
                                const frameInfo = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .parseAc3SyncFrame */ .LM)(context.suppliedPacket.data);
                                if (!frameInfo) {
                                ...
                                elementaryStream.info.numberOfChannels
                                    = _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .AC3_ACMOD_CHANNEL_COUNTS */ .ux[frameInfo.acmod] + frameInfo.lfeon;
                                elementaryStream.info.sampleRate = _shared_ac3_misc_js__WEBPACK_IMPORTED_MODULE_13__/* .AC3_SAMPLE_RATES */ .N[frameInfo.fscod];
                            }
                            else if (elementaryStream.info.codec === 'eac3') {
                                const frameInfo = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .parseEac3SyncFrame */ .oL)(context.suppliedPacket.data);
                                if (!frameInfo) {
                                    throw new Error('Invalid E-AC-3 audio stream; could not read sync frame from first packet.');
                                }
                                const sampleRate = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .getEac3SampleRate */ .PK)(frameInfo);
                                if (sampleRate === null) {
                                    throw new Error('Invalid E-AC-3 audio stream; reserved sample rate code found in first packet.');
                                }
                                elementaryStream.info.numberOfChannels = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .getEac3ChannelCount */ .zV)(frameInfo);
                                elementaryStream.info.sampleRate = sampleRate;
                            }
                            else if (elementaryStream.info.codec === 'dts') {
                                const frameInfo = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .parseDtsFrame */ .CX)(context.suppliedPacket.data);
                                if (!frameInfo) {
                            ...
                            elementaryStream.info.decoderConfig = {
                                codec: (0,_codec_js__WEBPACK_IMPORTED_MODULE_3__/* .extractAudioCodecString */ .X0)({
                                    codec: elementaryStream.info.codec,
                                    codecDescription: null,
    ...
    async getMimeType() {
        ...
        return (0,_mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .buildMpegTsMimeType */ .Vx)(codecStrings);
    }
    async readSection(startPos, full, contiguous = false) {
        ...
        while (true) {
            ...
            const isKnownSectionEnd = (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .binarySearchExact */ .pl)(this.sectionEndPositions, endPos, x => x) !== -1;
        ...
        if (mustAddSectionEnd) {
            const index = (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .binarySearchLessOrEqual */ .eE)(this.sectionEndPositions, endPos, x => x);
    ...
    async readPacketHeader(pos) {
        ...
        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .isThenable */ .Qg)(slice))
            slice = await slice;
        if (!slice) {
            return null;
        }
        const syncByte = (0,_reader_js__WEBPACK_IMPORTED_MODULE_11__/* .readU8 */ .eo)(slice);
        if (syncByte !== 0x47) {
            throw new Error('Invalid TS packet sync byte. Likely an internal bug, please report this file.');
        }
        const nextTwoBytes = (0,_reader_js__WEBPACK_IMPORTED_MODULE_11__/* .readU16Be */ .mH)(slice);
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        ...
        const nextByte = (0,_reader_js__WEBPACK_IMPORTED_MODULE_11__/* .readU8 */ .eo)(slice);
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    async readPacket(pos) {
        ...
        let slice = this.reader.requestSlice(pos, _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TS_PACKET_SIZE */ .ZT);
        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .isThenable */ .Qg)(slice))
            slice = await slice;
        if (!slice) {
            return null;
        }
        const bytes = (0,_reader_js__WEBPACK_IMPORTED_MODULE_11__/* .readBytes */ .io)(slice, _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TS_PACKET_SIZE */ .ZT);
...
const readPesPacket = (section, expectPts) => {
    (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(section.endPos !== null); // Can only read full PES packets from fully read sections
    ...
    (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(Number.isInteger(bytePos));
...
class MpegTsTrackBacking {
    ...
    getNumber() {
        ...
        for (const backing of demuxer.trackBackingEntries) {
            ...
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(backing instanceof MpegTsTrackBacking);
    ...
    getLanguageCode() {
        return _misc_js__WEBPACK_IMPORTED_MODULE_8__/* .UNDETERMINED_LANGUAGE */ .IR;
    }
    getDisposition() {
        return {
            ..._metadata_js__WEBPACK_IMPORTED_MODULE_7__/* .DEFAULT_TRACK_DISPOSITION */ .gM,
            primary: false,
        };
    }
    getTimeResolution() {
        return _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TIMESCALE */ .cS;
    }
    isRelativeToUnixEpoch() {
        return false;
    }
    ...
    createEncodedPacket(suppliedPacket, duration, options) {
        ...
        return new _packet_js__WEBPACK_IMPORTED_MODULE_10__/* .EncodedPacket */ .Z(options.metadataOnly ? _packet_js__WEBPACK_IMPORTED_MODULE_10__/* .PLACEHOLDER_DATA */ .T : suppliedPacket.data, packetType, suppliedPacket.pts / _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TIMESCALE */ .cS, Math.max(duration / _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TIMESCALE */ .cS, 0), suppliedPacket.sequenceNumber, suppliedPacket.data.byteLength);
    }
    async getFirstPacket(options) {
        const section = this.elementaryStream.firstSection;
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(section);
        const pesPacket = readPesPacket(section, true);
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(pesPacket);
    ...
    async doPacketLookup(timestamp, keyframesOnly, options) {
        const searchPts = (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .roundIfAlmostInteger */ .aI)(timestamp * _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TIMESCALE */ .cS);
        const demuxer = this.elementaryStream.demuxer;
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(firstSection);
        const firstPesPacketHeader = readPesPacketHeader(firstSection, true);
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(firstPesPacketHeader);
        ...
        const referencePointIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .binarySearchLessOrEqual */ .eE)(referencePesPackets, searchPts, x => x.pts);
        const referencePoint = referencePointIndex !== -1 ? referencePesPackets[referencePointIndex] : null;
        if (referencePoint && searchPts - referencePoint.pts < _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TIMESCALE */ .cS / 2) {
            ...
            if (reader.fileSize !== null) {
                ...
                if (numChunks > 1) {
                    ...
                    while (low <= high) {
                        ...
                        const chunkStartPos = (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .floorToMultiple */ .Q5)(mid * seekChunkSize, demuxer.packetStride)
            ...
            scanStartPos = (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .floorToMultiple */ .Q5)(startChunkIndex * seekChunkSize, demuxer.packetStride) + firstPesPacketHeader.sectionStartPos;
        }
        ...
        const retrieveEncodedPacket = async (sectionStartPos, predicate) => {
            ...
            while (true) {
                const topPts = (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .last */ ._g)(buffer.presentationOrderPackets)?.pts ?? -Infinity;
                if (topPts >= searchPts) {
                    break;
                }
            ...
            const targetIndex = (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .findLastIndex */ .Kl)(buffer.presentationOrderPackets, predicate);
            if (targetIndex === -1) {
                return null;
            }
            ...
            const result = await buffer.readNext();
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(result);
            const packet = this.createEncodedPacket(result.packet, result.duration, options);
            this.packetBuffers.set(packet, buffer);
            this.packetSectionStarts.set(packet, result.packet.sectionStartPos);
            return packet;
        ...
        if (!keyframesOnly || this.allPacketsAreKeyPackets()) {
            ...
            while (true) {
                ...
                outer: while (pesHeader) {
                    ...
                    if (pesHeader.pts <= searchPts) {
                        ...
                        if (this.elementaryStream.canBeTrustedWithKeyPackets) {
                            ...
                            (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(pesHeaderSection);
                ...
                if (bestKeyPesHeader) {
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(encodedPacket); // There must be one
                ...
                currentChunkStartPos = Math.max((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .floorToMultiple */ .Q5)(currentChunkStartPos - firstPesPacketHeader.sectionStartPos - seekChunkSize, demuxer.packetStride) + firstPesPacketHeader.sectionStartPos, firstPesPacketHeader.sectionStartPos);
            }
        }
    }
}
class MpegTsVideoTrackBacking extends MpegTsTrackBacking {
    ...
    async getDecoderConfig() {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(this.elementaryStream.info.decoderConfig);
...
const maybeInsertReferencePacket = (elementaryStream, pesPacketHeader) => {
    ...
    const index = (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .binarySearchLessOrEqual */ .eE)(referencePesPackets, pesPacketHeader.sectionStartPos, x => x.sectionStartPos);
    if (index >= 0) {
...
class PacketReadingContext {
    ...
    getCurrentPesPacket() {
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(packet);
        return packet;
    }
    async bufferData(length) {
        ...
        while (this.endPos < targetEndPos) {
            ...
            if (this.pesPackets.length === 0) {
                ...
                let currentPos = (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .last */ ._g)(this.pesPackets).sectionEndPos;
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(currentPos !== null);
                while (true) {
    ...
    async markNextPacket() {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(!this.suppliedPacket);
        ...
        if (elementaryStream.info.type === 'video') {
            ...
            while (true) {
                ...
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .isThenable */ .Qg)(remaining))
                ...
                while (i < length) {
                    ...
                    if (codec === 'avc') {
                        nalUnitType = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .extractNalUnitTypeForAvc */ .uN)(headerByte0);
                        isSlice = nalUnitType === _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .AvcNalUnitType */ .mY.NON_IDR_SLICE
                            || nalUnitType === _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .AvcNalUnitType */ .mY.SLICE_DPA
                            || nalUnitType === _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .AvcNalUnitType */ .mY.IDR;
                        isAccessUnitStart = nalUnitType === _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .AvcNalUnitType */ .mY.SEI
                            || nalUnitType === _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .AvcNalUnitType */ .mY.SPS
                            || nalUnitType === _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .AvcNalUnitType */ .mY.PPS
                            || nalUnitType === _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .AvcNalUnitType */ .mY.AUD;
                    }
                    else {
                        nalUnitType = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .extractNalUnitTypeForHevc */ .O9)(headerByte0);
                        ...
                        isSlice = nalUnitType <= _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .HevcNalUnitType */ .iJ.RASL_R
                            || (nalUnitType >= _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .HevcNalUnitType */ .iJ.BLA_W_LP && nalUnitType <= 21);
                        // VPS..FD, prefix SEI, and the reserved/unspecified non-VCL ranges
                        isAccessUnitStart = (nalUnitType >= _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .HevcNalUnitType */ .iJ.VPS_NUT && nalUnitType <= 37)
                            || nalUnitType === _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .HevcNalUnitType */ .iJ.PREFIX_SEI_NUT
                    ...
                    if (isSlice) {
                        ...
                        if (codec === 'avc') {
                            ...
                            const firstMacroblockInSlice = (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .readExpGolomb */ .IP)(new _shared_bitstream_js__WEBPACK_IMPORTED_MODULE_14__/* .Bitstream */ ._(headerBytes));
            ...
            while (true) {
                ...
                while (this.currentPos - startPos < remaining) {
                    ...
                    if (codec === 'aac') {
                        ...
                        let remaining = this.ensureBuffered(_adts_adts_reader_js__WEBPACK_IMPORTED_MODULE_1__/* .MAX_ADTS_FRAME_HEADER_SIZE */ .Y$);
                        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .isThenable */ .Qg)(remaining))
                            remaining = await remaining;
                        if (remaining < _adts_adts_reader_js__WEBPACK_IMPORTED_MODULE_1__/* .MAX_ADTS_FRAME_HEADER_SIZE */ .Y$) {
                            return;
                        }
                        const headerBytes = this.readBytes(_adts_adts_reader_js__WEBPACK_IMPORTED_MODULE_1__/* .MAX_ADTS_FRAME_HEADER_SIZE */ .Y$);
                        const header = (0,_adts_adts_reader_js__WEBPACK_IMPORTED_MODULE_1__/* .readAdtsFrameHeader */ .lh)(_reader_js__WEBPACK_IMPORTED_MODULE_11__/* .FileSlice */ .x$.tempFromBytes(headerBytes));
                        if (header) {
                            this.seekTo(possibleHeaderStartPos);
                            let remaining = this.ensureBuffered(header.frameLength);
                            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .isThenable */ .Qg)(remaining))
                                remaining = await remaining;
                            return this.supplyPacket(remaining, Math.round(_adts_adts_demuxer_js__WEBPACK_IMPORTED_MODULE_0__/* .SAMPLES_PER_AAC_FRAME */ .s * _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TIMESCALE */ .cS / elementaryStream.info.sampleRate));
                        }
                        else {
                        ...
                        this.skip(-1);
                        const possibleHeaderStartPos = this.currentPos;
                        let remaining = this.ensureBuffered(_shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_9__/* .MP3_FRAME_HEADER_SIZE */ .D_);
                        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .isThenable */ .Qg)(remaining))
                            remaining = await remaining;
                        if (remaining < _shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_9__/* .MP3_FRAME_HEADER_SIZE */ .D_) {
                            return;
                        }
                        const headerBytes = this.readBytes(_shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_9__/* .MP3_FRAME_HEADER_SIZE */ .D_);
                        const word = (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .toDataView */ .Zc)(headerBytes).getUint32(0);
                        const result = (0,_shared_mp3_misc_js__WEBPACK_IMPORTED_MODULE_9__/* .readMp3FrameHeader */ .P8)(word, null);
                        if (result.header) {
                            this.seekTo(possibleHeaderStartPos);
                            let remaining = this.ensureBuffered(result.header.totalSize);
                            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .isThenable */ .Qg)(remaining))
                                remaining = await remaining;
                            const duration = result.header.audioSamplesInFrame * _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TIMESCALE */ .cS
                                / elementaryStream.info.sampleRate;
                        ...
                        const frameSize = _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .AC3_FRAME_SIZES */ .Pl[3 * frmsizecod + fscod];
                        (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(frameSize !== undefined);
                        this.seekTo(possibleSyncPos);
                        remaining = this.ensureBuffered(frameSize);
                        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .isThenable */ .Qg)(remaining))
                            remaining = await remaining;
                        const duration = Math.round(_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .AC3_SAMPLES_PER_FRAME */ .Ir * _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TIMESCALE */ .cS / elementaryStream.info.sampleRate);
                        ...
                        const numblks = _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .EAC3_NUMBLKS_TABLE */ .FY[numblkscod];
                        this.seekTo(possibleSyncPos);
                        remaining = this.ensureBuffered(frameSize);
                        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .isThenable */ .Qg)(remaining))
                            remaining = await remaining;
                        ...
                        const duration = Math.round(samplesPerFrame * _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TIMESCALE */ .cS / elementaryStream.info.sampleRate);
                        return this.supplyPacket(remaining, duration);
                    }
                    else if (codec === 'dts') {
                        ...
                        this.skip(-1);
                        const possibleSyncPos = this.currentPos;
                        let remaining = this.ensureBuffered(_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .DTS_CORE_FRAME_HEADER_SIZE */ .mB);
                        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .isThenable */ .Qg)(remaining))
                            remaining = await remaining;
                        if (remaining < _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .DTS_CORE_FRAME_HEADER_SIZE */ .mB) {
                            return;
                        }
                        const headerBytes = this.readBytes(_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .DTS_CORE_FRAME_HEADER_SIZE */ .mB);
                        const core = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .parseDtsCoreFrameHeader */ .Wt)(headerBytes);
                        let leadingExss = core ? null : (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .parseDtsExssHeader */ .Zt)(headerBytes);
                        if (!core && !leadingExss) {
                            this.seekTo(possibleSyncPos + 1);
                            continue;
                        }
                        if (leadingExss && !leadingExss.asset) {
                            ...
                            this.seekTo(possibleSyncPos);
                            const headerBound = Math.min(leadingExss.frameSize, _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .DTS_EXSS_MAX_HEADER_SIZE */ .$N);
                            let remaining = this.ensureBuffered(headerBound);
                            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .isThenable */ .Qg)(remaining))
                                remaining = await remaining;
                            leadingExss = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .parseDtsExssHeader */ .Zt)(this.readBytes(remaining)) ?? leadingExss;
                        }
                        ...
                        if (core) {
                            ...
                            while (true) {
                                this.seekTo(possibleSyncPos);
                                const neededBytes = nextSubstreamPos + _codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .DTS_EXSS_HEADER_PREFIX_SIZE */ .l9;
                                ...
                                const exss = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .parseDtsExssHeader */ .Zt)(this.readBytes(_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .DTS_EXSS_HEADER_PREFIX_SIZE */ .l9));
                                if (!exss) {
                                    break;
                                }
                        ...
                        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .isThenable */ .Qg)(remaining))
                            remaining = await remaining;
                        const duration = Math.round(sampleCount * _mpeg_ts_misc_js__WEBPACK_IMPORTED_MODULE_12__/* .TIMESCALE */ .cS / elementaryStream.info.sampleRate);
                        return this.supplyPacket(remaining, duration);
                    }
                    else {
                        throw new Error('Unhandled.');
    ...
    supplyPacket(packetLength, intrinsicDuration) {
        ...
        if (this.lastSuppliedPesPacket === currentPesPacket) {
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(this.nextPts !== null);
            pts = this.nextPts;
        }
        else {
        ...
        if (randomAccessIndicator === 0 && !this.elementaryStream.canBeTrustedWithKeyPackets) {
            if (this.elementaryStream.info.type === 'audio') {
                ...
                if (this.elementaryStream.info.decoderConfig) {
                    const isKey = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_4__/* .determineVideoPacketType */ .PR)(this.elementaryStream.info.codec, this.elementaryStream.info.decoderConfig, data) === 'key';
...
class PacketBuffer {
    constructor(backing, context) {
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(this.reorderSize >= 0);
    }
    async readNext() {
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(presentationIndex !== -1);
        let duration;
    ...
    async ensureCurrentPacketHasNext() {
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .vA)(current);
        while (true) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   S: () => (/* binding */ OggDemuxer)
/* harmony export */ });
...
/* harmony import */ var _packet_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3936);
/* harmony import */ var _reader_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7735);
/* harmony import */ var _ogg_misc_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(9730);
/* harmony import */ var _ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(9841);
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class OggDemuxer extends _demuxer_js__WEBPACK_IMPORTED_MODULE_2__/* .Demuxer */ .B {
    constructor(input) {
        super(input);
        this.metadataPromise = null;
        this.bitstreams = [];
    ...
    async readMetadata() {
        return this.metadataPromise ??= (async () => {
            let currentPos = 0;
            while (true) {
                let slice = this.reader.requestSliceRange(currentPos, _ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .MIN_PAGE_HEADER_SIZE */ .b0, _ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .MAX_PAGE_HEADER_SIZE */ .H9);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(slice))
                    slice = await slice;
                if (!slice)
                    break;
                const page = (0,_ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readPageHeader */ .BF)(slice);
                if (!page) {
                    break;
                }
    ...
    async readVorbisMetadata(firstPacket, bitstream) {
        ...
        const view = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .toDataView */ .Zc)(firstPacket.data);
        ...
        bitstream.codecInfo.vorbisInfo = {
            ...
            modeBlockflags: (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_1__/* .parseModesFromVorbisSetupPacket */ .Co)(thirdPacket.data).modeBlockflags,
        };
        (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_1__/* .readVorbisComments */ .Oc)(secondPacket.data.subarray(7), this.metadataTags); // Skip header type and 'vorbis'
    }
    async readOpusMetadata(firstPacket, bitstream) {
        ...
        const header = (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_1__/* .parseOpusIdentificationHeader */ .Qf)(firstPacket.data);
        bitstream.numberOfChannels = header.outputChannelCount;
        bitstream.sampleRate = _codec_js__WEBPACK_IMPORTED_MODULE_0__/* .OPUS_SAMPLE_RATE */ .yo; // Always the same
        bitstream.codecInfo.opusInfo = {
            preSkip: header.preSkip,
        };
        (0,_codec_data_js__WEBPACK_IMPORTED_MODULE_1__/* .readVorbisComments */ .Oc)(secondPacket.data.subarray(8), this.metadataTags); // Skip 'OpusTags'
    }
    async readPacket(startPage, startSegmentIndex) {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(startSegmentIndex < startPage.lacingValues.length);
        ...
        outer: while (true) {
            ...
            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(pageSlice))
                pageSlice = await pageSlice;
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(pageSlice);
            const pageData = (0,_reader_js__WEBPACK_IMPORTED_MODULE_6__/* .readBytes */ .io)(pageSlice, currentPage.dataSize);
            while (true) {
            ...
            while (true) {
                let headerSlice = this.reader.requestSliceRange(currentPos, _ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .MIN_PAGE_HEADER_SIZE */ .b0, _ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .MAX_PAGE_HEADER_SIZE */ .H9);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(headerSlice))
                    headerSlice = await headerSlice;
                if (!headerSlice) {
                    return null;
                }
                const nextPage = (0,_ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readPageHeader */ .BF)(headerSlice);
                if (!nextPage) {
                    return null;
                }
    ...
    async findNextPacketStart(lastPacket) {
        ...
        while (true) {
            ...
            const nextPage = (0,_ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readPageHeader */ .BF)(slice);
            if (!nextPage) {
                return null;
            }
    ...
    async getMimeType() {
        ...
        return (0,_ogg_misc_js__WEBPACK_IMPORTED_MODULE_7__/* .buildOggMimeType */ .Ob)({
            codecStrings: codecStrings.filter(Boolean),
        });
    }
    async getTrackBackings() {
...
class OggAudioTrackBacking {
    constructor(bitstream, demuxer) {
        ...
        this.sequentialScanMutex = new _misc_js__WEBPACK_IMPORTED_MODULE_4__/* .AsyncMutex */ .aD();
        ...
        this.internalSampleRate = bitstream.codecInfo.codec === 'opus'
            ? _codec_js__WEBPACK_IMPORTED_MODULE_0__/* .OPUS_SAMPLE_RATE */ .yo
    ...
    getNumber() {
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(index !== -1);
        return index + 1;
    }
    getNumberOfChannels() {
    ...
    async getDecoderConfig() {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(this.bitstream.codecInfo.codec);
        return {
    ...
    granulePositionToTimestampInSamples(granulePosition) {
        if (this.bitstream.codecInfo.codec === 'opus') {
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(this.bitstream.codecInfo.opusInfo);
    ...
    createEncodedPacketFromOggPacket(packet, additional, options) {
        ...
        const { durationInSamples, vorbisBlockSize } = (0,_ogg_misc_js__WEBPACK_IMPORTED_MODULE_7__/* .extractSampleMetadata */ .nL)(packet.data, this.bitstream.codecInfo, additional.vorbisLastBlocksize);
        const encodedPacket = new _packet_js__WEBPACK_IMPORTED_MODULE_5__/* .EncodedPacket */ .Z(options.metadataOnly ? _packet_js__WEBPACK_IMPORTED_MODULE_5__/* .PLACEHOLDER_DATA */ .T : packet.data, 'key', Math.max(0, additional.timestampInSamples) / this.internalSampleRate, durationInSamples / this.internalSampleRate, packet.endPage.headerStartPos + packet.endSegmentIndex, packet.data.byteLength);
    ...
    async getFirstPacket(options) {
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(this.bitstream.lastMetadataPacket);
    ...
    async getPacket(timestamp, options) {
        ...
        const timestampInSamples = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .roundIfAlmostInteger */ .aI)(timestamp * this.internalSampleRate);
        ...
        outer: while (lowPage.headerStartPos + lowPage.totalSize < high) {
            ...
            while (true) {
                const until = Math.min(searchStartPos + _ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .MAX_PAGE_SIZE */ .H4, high - _ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .MIN_PAGE_HEADER_SIZE */ .b0);
                let searchSlice = this.demuxer.reader.requestSlice(searchStartPos, until - searchStartPos);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(searchSlice))
                    searchSlice = await searchSlice;
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(searchSlice);
                const found = (0,_ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .findNextPageHeader */ .v5)(searchSlice, until);
                if (!found) {
                    high = mid + _ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .MIN_PAGE_HEADER_SIZE */ .b0;
                    continue outer;
                }
                let headerSlice = this.demuxer.reader.requestSliceRange(searchSlice.filePos, _ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .MIN_PAGE_HEADER_SIZE */ .b0, _ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .MAX_PAGE_HEADER_SIZE */ .H9);
                if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(headerSlice))
                    headerSlice = await headerSlice;
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(headerSlice);
                const page = (0,_ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readPageHeader */ .BF)(headerSlice);
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(page);
                let pageValid = false;
                if (page.serialNumber === this.bitstream.serialNumber) {
                    ...
                    const bytes = (0,_reader_js__WEBPACK_IMPORTED_MODULE_6__/* .readBytes */ .io)(pageSlice, page.totalSize);
                    const crc = (0,_ogg_misc_js__WEBPACK_IMPORTED_MODULE_7__/* .computeOggPageCrc */ ._S)(bytes);
        ...
        while (true) {
            ...
            let slice = this.demuxer.reader.requestSliceRange(nextPos, _ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .MIN_PAGE_HEADER_SIZE */ .b0, _ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .MAX_PAGE_HEADER_SIZE */ .H9);
            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .isThenable */ .Qg)(slice))
                slice = await slice;
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(slice);
            const nextPage = (0,_ogg_reader_js__WEBPACK_IMPORTED_MODULE_8__/* .readPageHeader */ .BF)(slice);
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(nextPage);
            currentPage = nextPage;
            if (currentPage.serialNumber === this.bitstream.serialNumber) {
                previousPages.push(currentPage);
            }
        }
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(currentPage.granulePosition !== -1);
        ...
        if (currentPage.headerStartPos === startPosition.startPage.headerStartPos) {
            ...
            if (nextPosition) {
                ...
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(endPosition);
        ...
        while (currentPage !== null) {
            (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(currentSegmentIndex !== null);
            ...
            if (!skipPacket) {
                ...
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(encodedPacket);
                let encodedPacketMetadata = this.encodedPacketToMetadata.get(encodedPacket);
                (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(encodedPacketMetadata);
    ...
    async getPacketSequential(timestamp, options) {
        ...
        try {
            ...
            const index = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .binarySearchLessOrEqual */ .eE)(this.sequentialScanCache, timestampInSamples, x => x.timestampInSamples);
            let currentPacket;
            if (index !== -1) {
            ...
            while (currentPacket && currentPacket.timestamp < timestamp) {
                ...
                if (i === 100) {
                    ...
                    (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(metadata);
                    if (this.sequentialScanCache.length > 0) {
                        // If we reach this case, we must be at the end of the cache
                        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)((0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .last */ ._g)(this.sequentialScanCache).timestampInSamples <= metadata.timestampInSamples);
                    }
...
const findPacketStartPosition = (pageList, endPage, endSegmentIndex) => {
    ...
    outer: while (true) {
        ...
        (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .assert */ .vA)(segmentIndex === -1);
        ...
        const previousPage = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .findLast */ .Uk)(pageList, x => x.headerStartPos < page.headerStartPos);
        if (!previousPage) {
            return null;
        }
        page = previousPage;
...
const findPreviousPacketEndPosition = (pageList, startPage, startSegmentIndex) => {
    ...
    const previousPage = (0,_misc_js__WEBPACK_IMPORTED_MODULE_4__/* .findLast */ .Uk)(pageList, x => x.headerStartPos < startPage.headerStartPos);
    if (!previousPage) {
        return null;
    }
...
class Reader {
    ...
    requestSlice(start, length) {
        ...
        if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_1__/* .isThenable */ .Qg)(result)) {
    ...
    requestSliceRange(start, minLength, maxLength) {
        ...
        if (this.fileSizeNonStrict !== null) {
            ...
            if ((0,_misc_js__WEBPACK_IMPORTED_MODULE_1__/* .isThenable */ .Qg)(promisedAttempt)) {
