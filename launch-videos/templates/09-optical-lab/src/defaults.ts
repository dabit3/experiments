...
export const defaultProps: LaunchProps = {
  ...
  media: {
    ...
    pick: {
      ...
      width: 2988,
      height: 1624,
      highlight: { rect: { x: 0.502, y: 0.64, w: 0.176, h: 0.045 } },
    },
    work: {
  ...
  scenes: [
    { id: "establish", kind: "title", durationInFrames: 90, media: "hero" },
    {
      id: "pick",
      kind: "inspect",
      ...
      captionIndex: 0,
      inspection: {
        focus: { x: 0.497, y: 0.545, w: 0.186, h: 0.195 },
        window: { x: 0.03, y: 0.06, w: 0.36 },
        label: "Virtual environment: macOS selected",
        openAt: 20,
      },
    },
    {
    ...
    },
    {
      ...
      inspection: {
        ...
        label: "Test summary: all tests passed",
        openAt: 20,
      },
    },
    {
