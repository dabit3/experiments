...
Latest run of the skill — Devin driving Chrome on the left, the test flow on the right (the six
tests, each assertion and its result appear at the moment Devin recorded them; 18/18 passed):
**[Watch the test video (mp4)](https://app.devin.ai/attachments/dca6b4ae-539d-4fee-b325-930dcbadab67/airline-booking-e2e-devin-test.mp4)**

![Animated preview of the test video](https://app.devin.ai/attachments/85a015b7-74ff-4b13-a2d1-667cd0b87188/airline-booking-devin-test-preview.webp)
