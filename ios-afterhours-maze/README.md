...
Select Blue Hour or Velvet Circuit, then **Enter the maze**. Swipe anywhere on the board or tap the four arrow pads. Turns queue until the next legal corner; the opposite direction reverses immediately. Your comet moves automatically, stopping at walls. Side tunnels wrap to the opposite edge.
