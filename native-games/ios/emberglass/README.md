...
A native, offline iPhone glassblowing skill game. SwiftUI draws luminous, layered
glass with custom Bézier geometry, moving highlights and fine interference lines.
Three linked stages turn a molten gather into a scored, collectible vessel.
...
successful end-to-end model progression and relaunch persistence.

## Playing

1. **Heat, 14 seconds:** hold the orange pad to warm the white temperature
...
- Reduce Motion stops the idle highlight animation and result scale reveal.
