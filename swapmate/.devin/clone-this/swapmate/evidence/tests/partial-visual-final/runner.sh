#!/usr/bin/env bash
# Diagnostic copy: web/iOS/macOS plus one bot; not the four-platform gate.
# The board-A-only fixture avoids assuming a particular opening from the bot.
...
ROOT="/Users/devin/repos/experiments/swapmate"
APP="$ROOT/app"
SERVER="$ROOT/server"
PORT="${PORT:-8792}"
SEED="${SEED:-42}"
...
OUT="${OUT:-$ROOT/.devin/clone-this/swapmate/evidence/tests/partial-visual-$STAMP}"
