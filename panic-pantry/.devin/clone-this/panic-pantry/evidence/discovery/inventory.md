...
| feature-chop | Raw ingredient chopped on a board with progress | `simulation.dart` chop progress per tick; sprite progress bar | plan-driven E2E serves 11 dishes requiring chopped ingredients; core test |
